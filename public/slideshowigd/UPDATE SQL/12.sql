...
/****** Object:  StoredProcedure [dbo].[web_D10_Diagnosa_IGD]    Script Date: 13/03/2018 17:34:13 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[web_D10_Diagnosa_IGD]
AS  
BEGIN  
...
and pd.clinic_id in (select clinic_id from clinic where stype_id in (5))
