<?php
  ...
  $qPasienDaerah = 'execute dbo.web_D12_Pasien_Perdaerah';
  $rPasienDaerah = querryResult($dbconnect,$qPasienDaerah);
  $menu=12;
  $header='JUMLAH PASIEN PER DAERAH';
 ?>
     ...
     <!-- </div> -->
         ...
         <?php
         $qSlide = 'select timeslide from WEBSITE_MENU where MENU_ID=12';
