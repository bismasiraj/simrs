<?php
  ...
  $qDiagnosaRanap = 'execute dbo.web_D09_Diagnosa_Ranap';
  $rDiagnosaRanap = querryResult($dbconnect,$qDiagnosaRanap);
 ...
 ?>
          ...
          "titles": [
            {
              "id": "Title-1",
              "size": 15,
              "text": "Top 10 Diagnosa Rawat Inap"
            }
          ],
          "dataProvider": [
            <?php foreach ($rDiagnosaRanap as $key => $value): ?>
              {
                <?php echo "\"category\": \"".$rDiagnosaRanap[$key]['name_of_diagnosa']."\"," ?>
                <?php echo "\"column-1\": ".$rDiagnosaRanap[$key]['jml']."," ?>
                "color": "#375E97"
              },
            <?php endforeach; ?>
          ]
     ...
     <!-- </div> -->
              ...
              <?php
              $qSlide = 'select timeslide from WEBSITE_MENU where MENU_ID=9';
