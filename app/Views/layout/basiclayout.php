...
<head>
    ...
    <?php echo view('partials/title-meta.php', [
        'title' => $orgunit['NAME_OF_ORG_UNIT'],
    ]);
    ?>
    <?php echo view('partials/head-css.php');
    ?>

</head>

<?php echo view('partials/body.php'); ?>

<!-- Begin page -->
<div id="layout-wrapper">

    <?php echo view('partials/menu.php'); ?>
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <?php echo view('partials/page-title.php', [
                    'title' => 'dashboard',
                    'pagetitle' => 'dashboard',
                    'subtitle' => 'dashboard',
                ]);
...
<?php echo view('partials/right-sidebar.php'); ?>

<?php echo view('partials/vendor-scripts.php'); ?>
