                ...
                <div class="box box-info">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a data-toggle="" href="<?php echo base_url() ?>admin/patient/import" id="addp" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo lang('Word.import_patient'); ?></a>
                            <a href="<?php echo base_url() ?>admin/admin/disablepatient" class="btn btn-primary btn-sm"><i class="fa fa-reorder"></i> <?php echo lang('Word.disabled_patient_list'); ?></a>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="">
                        ...
                        <table class="table table-striped table-bordered table-hover ajaxlist" data-export-title="<?= lang('Word.patient_list'); ?>">
                            <thead>
                                <tr>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="row ptt10">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12">
                                                ...
                                                <img class="profile-user-img img-responsive" src="<?php echo base_url() . 'uploads\staff_images\staff\no_image.png' ?>" id="image" alt="User profile picture">
                                            </div><!-- ./col-md-3 -->
                                        </div>
...
<script type="text/javascript">
    ...
    function editRecord(id) {
        ...
        //         // $("epatientid").val(data.no_registration);
        //         // $("#epatient_name").html(data.name_of_pasien + " (" + data.no_registration + ")");
        //         // $("#ekk_no").html(data.KK_NO);
        //         // coverage.forEach((element, index) => {
        //         //     if (index == data.coverage_id) {
        //         //         $("#ecoverages").html(element);
        //         //     }
        //         // });
        //         // $("#epasien_id").html(data.pasien_id);
        //         // kelas.forEach((element, index) => {
        //         //     if (index == data.class_id) {
        //         //         $("#eclass_id").html(element);
        //         //     }
        //         // });
        //         // $("#eplacebirth").html(data.place_of_birth);
        //         // $("#edatebirth").html(data.date_of_birth);
        //         // $("#eage").html(data.patient_age);
        //         // $("#edescription").html(data.description);
        //         // $("#eaddress").html(data.contact_address);
        //         // $("#ertrw").html(data.rt + " / " + data.rw);
        //         // kalurahan.forEach(kalvalue => {
        //         //     if (kalvalue[0] == data.kal_id) {
        //         //         $("#ekalurahan").html(kalvalue[1]);
        //         //     }
        //         //     kota.forEach(kotavalue => {
        //         //         if (kalvalue[2] == kotavalue[1]) {
        //         //             $("#ekota").html(kotavalue[2]);
        //         //         }
        //         //         prov.forEach(provvalue => {
        //         //             if (kotavalue[0] == provvalue[0]) {
        //         //                 $("#eprov").html(provvalue[2]);
        //         //             }
        //         //         });
        //         //     });
        //         // });

        //         // $("#ephone").html(data.phone_number + " / " + data.mobile);
        //         // statusPasien.forEach((element, index) => {
        //         //     if (index == data.status_pasien_id) {
        //         //         $("#estatus").html(element);
        //         //     }
        //         // });
        //         // payor.forEach(payorvalue => {
        //         //     if (payorvalue[1] == data.payor_id) {
        //         //         $("#epayor").html(payorvalue[3]);
        //         //     }
        //         // });

        //         // $("#eayah").html(data.father);
        //         // $("#eibu").html(data.mother);
        //         // $("#esutri").html(data.spouse);
        //         // education.forEach((element, index) => {
        //         //     if (index == data.education_type_code) {
        //         //         $("#eedukasi").html(element);
        //         //     }
        //         // });
        //         // job.forEach(jobvalue => {
        //         //     if (jobvalue[0] == data.job_id) {
        //         //         $("#epekerjaan").html(jobvalue[1]);
        //         //     }
        //         // });
        //         // blood.forEach(bloodvalue => {
        //         //     if (bloodvalue[1] == data.blood_type_id) {
        //         //         $("#egoldar").html(bloodvalue[0]);
        //         //     }
        //         // });
        //         // agama.forEach(agamavalue => {
        //         //     if (agamavalue[0] == data.kode_agama) {
        //         //         $("#eagama").html(agamavalue[1]);
        //         //     }
        //         // });
        //         // marital.forEach(maritalvalue => {
        //         //     if (maritalvalue[0] == data.maritalstatusid) {
        //         //         $("#eperkawinan").html(maritalvalue[1]);
        //         //     }
        //         // });
