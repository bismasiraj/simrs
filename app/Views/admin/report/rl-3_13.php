...
<body>
    <div class="container-fluid">
        <div class="row">
            <h4 class="text-start">RL 3.13 PENGADAAN OBAT</h4>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody id="data-all">
                ...
                foreach (@$data as $index => $row) {
                    ...
                    echo "<td class='p-1'>" . htmlspecialchars(@$row['generic']) . "</td>";
                    echo "<td class='p-1'>" . htmlspecialchars(@$row['isactive']) . "</td>";
                    echo "<td class='p-1'>" . htmlspecialchars(@$row['isgeneric']) . "</td>";
                    echo "<td class='p-1'>" . htmlspecialchars(@$row['isformularium']) . "</td>";

                    echo "</tr>";
                    $totalJumlahisactive += $row['isactive'];
                    $totalJumlahisgeneric += $row['isgeneric'];
                    $totalJumlahisformularium += $row['isformularium'];
                }
                ?>
                <tr>
                    <td colspan='2' class='p-1 text-end'><strong>Total:</strong></td>

                    <td class="p-1"><strong><?php echo htmlspecialchars($totalJumlahisactive); ?></strong></td>
                    <td class="p-1"><strong><?php echo htmlspecialchars($totalJumlahisgeneric); ?></strong></td>
                    <td class="p-1"><strong><?php echo htmlspecialchars($totalJumlahisformularium); ?></strong></td>
                </tr>
            </tbody>
        </table>
