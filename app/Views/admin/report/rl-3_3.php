...
<body>
    <div class="container-fluid">
        <div class="row">
            <h4 class="text-start">RL 3.3 PELAYANAN GIGI MULUT</h4>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody id="data-all">
                ...
                foreach ($data as $index => $row) {
                    ...
                    echo "<td class='p-1'>" . htmlspecialchars(@$row['tarif']) . "</td>";
                    echo "</tr>";
                    $totalTarif += (float) @$row['tarif'];
                }
                ?>
                <tr>
                    <td colspan="3" class="p-1 text-end"><strong>Total:</strong></td>
                    <td class="p-1"><strong><?php echo htmlspecialchars(number_format($totalTarif, 2)); ?></strong></td>
                </tr>
            </tbody>
                ...
                success: function(response) {
                    ...
                    if (Array.isArray(response.data)) {
                        ...
                        response.data.forEach(function(row, index) {
                            ...
                            newRow += "<td class='p-1'>" + row.tarif + "</td>";
                            newRow += "</tr>";

                            $('#data-all').append(newRow);


                            totalTarif += parseFloat(row.tarif) || 0;
                        });

                        let totalRow = "<tr>";
                        totalRow +=
                            "<td colspan='3' class='p-1 text-end'><strong>Total:</strong></td>";
                        totalRow += "<td class='p-1'><strong>" + totalTarif.toFixed(2) +
                            "</strong></td>";
                        totalRow += "</tr>";
