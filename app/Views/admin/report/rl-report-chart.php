        ...
        <div class="modal-content rounded-4">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <canvas id="chartReport" width="400" height="300"></canvas>
                    </div>
                </div>
            </div>
...
$("#register").on('submit', (function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            let dataChart = data.body;

            console.log(data.body);


            const chartData = dataChart.filter(row => !row[0].includes('TOTAL'));

            const labels = chartData.map(row => row[0]);
            const baruValues = chartData.map(row => row[1]);
            const lamaValues = chartData.map(row => row[2]);
