...
<body>
    <div class="container-fluid">
        <div class="row">
            <h4 class="text-start">RL 4-A DATA KEADAAN MORBIDITAS PASIEN RAWAT INAP RUMAH SAKIT</h4>
        </div>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="p-1 align-middle text-center" colspan="18">Pasien Keluar (Hidup - Mati) Menurut Golongan
                        Umur</th>
            ...
            <tbody id="data-all">
                ...
                foreach ($groupedData as $daftarterinci => $ageGroups) {
                    ...
                    foreach ($ageGroups as $ageGroup => $row) {
                        ...
                        echo "<td class='p-1 text-center'>" . $row['mati'] . "</td>";
                        echo "</tr>";
                    }
                }
                ?>
                ...
                success: function(response) {
                    ...
                    if (Array.isArray(response.data)) {
                        ...
                        response.data.forEach(function(row) {
                            ...
                            if (result_id == 2 || result_id == 3) {
                                totalData[daftarterinci]['totalMati'] += row.jml;
                                if (!totalData[daftarterinci]['ageGroups'][ageGroup]) {
                                    totalData[daftarterinci]['ageGroups'][ageGroup] = {
                                        'L': 0,
                                        'P': 0,
                        ...
                        for (const daftarterinci in totalData) {
                            ...
                            newRow += "<td class='p-1 text-center'>" + (row.totalL + row
                                .totalP) + "</td>";
                            newRow += "<td class='p-1 text-center'>" + row.totalMati + "</td>";
                            newRow += "</tr>";
