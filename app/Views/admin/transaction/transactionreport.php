                                ...
                                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text text-right"><?php echo $this->lang->line('amount') . '(' . $currency_symbol . ')'; ?></th>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text text-right">
                                                    <button type="button" class="btn btn-default btn-xs daily_collection" id="load" data-toggle="tooltip" data-date="<?php echo $dt_value['date']; ?>" data-deposite- title="" data-loading-text="<i class='fa fa-spinner fa-spin'></i>" data-original-title="<?php echo $this->lang->line('view_collection'); ?>" autocomplete="off"><i class="fa fa-list"></i></button>
                                                </td>
                                            </tr>
                                        <?php
                                        }
