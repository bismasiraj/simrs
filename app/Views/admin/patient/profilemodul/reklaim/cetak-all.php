            ...
            <table class="table table-bordered mb-2">
                ...
                <tr>
                    <td>
                        ...
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['lingkar_kepala']) ? '-' : @$neonatus['lingkar_kepala']; ?></p>
                    </td>
                    <td>
                        <b>Lingkar Dada</b>
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['lingkar_dada']) ? '-' : @$neonatus['lingkar_dada']; ?></p>
                    </td>
                    <td>
                        <b>SpO2</b>
                ...
                <tr>
                    ...
                    <td>
                        <b>Kesan Umum</b>
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['keadaan_umum']) ? '-' : @$neonatus['keadaan_umum']; ?></p>
                    </td>
                    <td>
                        <b>Pergerakan</b>
                        <p class="m-0 mt-1 p-0"><?= empty(@$neonatus['pergerakan']) ? '-' : @$neonatus['pergerakan']; ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <b>Warna Kulit</b>
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['warna_kulit']) ? '-' : @$neonatus['warna_kulit']; ?></p>
                    </td>
                    <td>
                        <b>Turgor</b>
                ...
                <tr>
                    ...
                    <td>
                        <b>Reflek Moro</b>
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['reflek_moro']) ? '-' : @$neonatus['reflek_moro']; ?></p>
                    </td>
                    <td>
                        <b>Reflek Menghisap</b>
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['reflek_menghisap']) ? '-' : @$neonatus['reflek_menghisap']; ?></p>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <b>Tonus Leher</b>
                        <p class="m-0 mt-1 p-0">
                            <?= empty(@$neonatus['tonus_leher']) ? '-' : @$neonatus['tonus_leher']; ?></p>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <b>Resusitasi</b>
                        <p class="m-0 mt-1 p-0"><?= empty(@$neonatus['resusitasi']) ? '-' : @$neonatus['resusitasi']; ?>
                        </p>
                    </td>
                </tr>
                <tr>
