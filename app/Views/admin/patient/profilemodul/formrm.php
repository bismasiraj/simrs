...
<script type="text/javascript">
    ...
    $('#lainnyaListLink').append('<li class="list-group-item"><a href="#" onclick="openPopUpTab(\'<?= base_url() . '/admin/rm/lainnya/surat_rujukan/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armbody_id").val() + '\')" target="_blank">Surat Rujukan</a></li>')
    ...
    $('#lainnyaListLink').append('<li class="list-group-item"><a href="#" onclick="openPopUpTab(\'<?= base_url() . '/admin/rm/lainnya/bedah_umum/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armbody_id").val() + '\')" target="_blank">Assessmen Bedah Umum Rawat Inap</a></li>')
    $('#lainnyaListLink').append('<li class="list-group-item"><a href="#" onclick="openPopUpTab(\'<?= base_url() . '/admin/rm/lainnya/nadi_suhu/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armbody_id").val() + '\')" target="_blank">Lembar Nadi dan Suhu</a></li>')
    ...
    $('#lainnyaListLink').append('<li class="list-group-item"><a href="#" onclick="openPopUpTab(\'<?= base_url() . '/admin/rm/lainnya/surat_lahir/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armbody_id").val() + '\')" target="_blank">Surat Keterangan Lahir</a></li>')
    $('#lainnyaListLink').append('<li class="list-group-item"><a href="#" onclick="openPopUpTab(\'<?= base_url() . '/admin/rm/lainnya/laboratorium_cetak/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armbody_id").val() + '\')" target="_blank">Laboratorium</a></li>')
    $('#lainnyaListLink').append('<li class="list-group-item"><a href="#" onclick="openPopUpTab(\'<?= base_url() . '/admin/rm/lainnya/radiologi_cetak/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armbody_id").val() + '\')" target="_blank">Radiologi</a></li>')
