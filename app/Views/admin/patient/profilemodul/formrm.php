...
<script type="text/javascript">
    ...
    $('#medisListLink').append('<li class="list-group-item"><a href="<?= base_url() . 'admin/rm/medis/rawat_jalan/' . base64_encode(json_encode($visit)); ?>' + '/' + $("#armpasien_diagnosa_id").val() + '" target="_blank">Assessmen Medis Rawat Jalan</a></li>')
