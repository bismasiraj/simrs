                ...
                <div class="col-lg-9 col-md-9 col-xs-12">
                    <div class="accordion mt-4">
                        <div class="text-center mb-3">
                            <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#create-modal-casemanager" id="btn-create-casemanager">+ Tambah Dokumen</button>
                        </div>
                            ...
                            <table class="table table-bordered table-hover table-centered" style="text-align: center">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th scope="col" width="1%"><span class="mdi mdi-magnify-plus"></span></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formDokumentCM">
                    ...
                    <div id="content-param-casemanager"></div>
                </form>
            </div>
