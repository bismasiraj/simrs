    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-12">
            <div class="box-tab-header">
                <!-- <h3 class="box-tab-title">E-Resep</h3> -->
            ...
            <div class="table-responsive">
                ...
                <div class="box-tab-tools">
                    <form id="formprescription" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post" class="ptt10">
                        <table id="eresepTable" class="table table-borderedcustom table-bordered table-hover" style="display: none;">
                        ...
                        <div class="pull-right">
                            <button type="submit" id="formaddprescrbtn" name="save" data-loading-text="<?php echo lang('processing') ?>" class="btn btn-info pull-right"><i class="fa fa-check-circle"></i> <span>Simpan</span></button>
                            <button style="margin-right: 10px" type="button" id="historyprescbtn" onclick="holdModal('historyEresepModal')" name="save" data-loading-text="<?php echo lang('processing') ?>" class="btn btn-info pull-right"><i class="fa fa-history"></i> <span>History</span></button>
                        </div>
                    </form>
                </div>
