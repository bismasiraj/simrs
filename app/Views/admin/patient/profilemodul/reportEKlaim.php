...
<script type="text/javascript">
    ...
    $('#ranapFile_url').append(
        '<li class="list-group-item"><a href="<?= base_url() . 'admin/reklaim/Cetak/cetakAllGrouping/' . base64_encode(json_encode($visit)); ?>' +
        '/' + $("#armbody_id").val() + '?result=RIF&type=Persalinan' + '" target="_blank">Laporan Persalinan</a></li>')
    $('#ranapFile_url').append(
        '<li class="list-group-item"><a href="<?= base_url() . 'admin/reklaim/Cetak/cetakAllGrouping/' . base64_encode(json_encode($visit)); ?>' +
        '/' + $("#armbody_id").val() + '?result=RIF&type=OPRS' + '" target="_blank">Laporan Operasi</a></li>')
    $('#ranapFile_url').append(
        '<li class="list-group-item"><a href="<?= base_url() . 'admin/reklaim/Cetak/cetakAllGrouping/' . base64_encode(json_encode($visit)); ?>' +
        '/' + $("#armbody_id").val() + '?result=RIF&type=Anestesi' + '" target="_blank">Laporan Anestesi</a></li>')
    $('#ranapFile_url').append(
        '<li class="list-group-item"><a href="<?= base_url() . 'admin/reklaim/Cetak/cetakAllGrouping/' . base64_encode(json_encode($visit)); ?>' +
