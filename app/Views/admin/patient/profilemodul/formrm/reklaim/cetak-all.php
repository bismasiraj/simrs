...
<?php elseif ($type === 'ResumeMedis'): ?>
    <div class="page-break">
        ...
        <script>
            ...
            let signMedis1 = <?= json_encode($resumeMedis['sign']); ?>;

            signMedis1 = JSON.parse(signMedis1)
        </script>
        <script>
            $.each(signMedis1, function(key, value) {
                console.log(value)
...
<?php elseif ($type === 'Persalinan'): ?>
    <?php if (!empty($persalinan['neonatus'])) : ?>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="box box-info">
                                            <div class="box-body">
                                                <canvas id="myChartMonitoringRecoveryRoom1" width="auto" height="200"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="monitoringRecoveryRoom-1" class="table tablecustom-responsive">
                                <table class="table">
                                    ...
                                    <tbody id="bodyDatamyChartMonitoringRecoveryRoom1" class="table-group-divider">
                                        <tr>
                        ...
                        <div class="row">
                            <div id="cairanMasuk-1" class="table tablecustom-responsive">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="box box-info">
                                            <div class="box-body">
                                                <canvas id="myChartMonitoringDurante1" width="auto" height="200"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="monitoringDurante-1" class="table tablecustom-responsive">
                                <table class="table">
                                    ...
                                    <tbody id="bodyDatamyChartMonitoringDurante1" class="table-group-divider">
                                        <tr>
                                            <td colspan="10" class="text-center">Data Kosong</td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="CAnestesiandsedasi-1" class="table tablecustom-responsive">
                                            <table class="table">
                                                ...
                                                <tbody id="bodyDataCAnestesiandsedasi1" class="table-group-divider">
                                                    <tr>
                                                        <td colspan="10" class="text-center">Data Kosong</td>
                                                    </tr>
                                                </tbody>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        getRequestVtRangeAnesthesia1({
                            vactination_id: val?.document_id,
                            filters: ["13", "all", "11"],
                            body_requestCharts: ["myChartMonitoringDurante1", "myChartMonitoringRecoveryRoom1",
                                null
                            ],
                            body_requestTables: ["bodyDatamyChartMonitoringDurante1",
                                "bodyDatamyChartMonitoringRecoveryRoom1",
                                "bodyDataCAnestesiandsedasi1"
                            ]
                        });
                    ...
                    const getDataDiagnosaPreoperatif1 = (props) => {
                        ...
                        if (props?.data) {
                            props?.data?.diagnosa?.map(item => {
                                ...
                                result += `<tr>
                                <td>${item?.diagnosa_desc ?? item?.diagnosa_name}</td>
...
<?php elseif ($type === 'TRIASE'): ?>
    ...
    <div class="page-break">
        ...
        <script>
            let val1 = <?= json_encode($resumeMedis['val']); ?>;
            let sign1 = <?= json_encode($resumeMedis['sign']); ?>;

            sign1 = JSON.parse(sign1)
        </script>
        <script>
    ...
    <?php if (!empty($anestesi['val'])) : ?>
        ...
        <div class=" landscape">
            ...
            <div class="">
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        let valAnes = <?= json_encode($anestesi['val']); ?>;
                        let aParamVal = <?= json_encode($anestesi['a_paramVal']); ?>;
                        let aParam = <?= json_encode($anestesi['a_param']); ?>;
                        getRequestVtRangeAnesthesia({
                            vactination_id: valAnes?.document_id,
                            filters: ["13", "all", "11"],
                    ...
                    const getDataTreatment = (data) => {
                        getDataList(
                            ...
                            (res) => {
                                ...
                                $("#macam-prosedur-treat-name").html(data?.tarif_id)
                                $("#nama-tindakan").html(data?.tarif_id)
