                ...
                <div class="border border-1" style="height: auto; min-height:100px;">
                    <table class="table table-borderless">
                        ...
                        <tr class="mb-0">
                            ...
                            <td width="1%">:</td>
                            <td><?= $anestesi['visit']['visitor_address']; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="col-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-auto" align="center">
                        <div>Dokter</div>
                        <div class="mb-1">
                            <div id="qrcode-anestesi-one"></div>
                        </div>
                        <div id="qrcode-anestesi-one_name"></div>
...
<div class=" landscape">
    ...
    <body>
        ...
        <div class="row">
            <div class="col-auto" align="center">
                ...
                <div id="qrcode-anestesi_name"></div>
            ...
            <div class="col-auto" align="center">
                <div>Pasien</div>
                <div class="mb-1">
                    <div id="qrcode-anestesi1">
                    </div>
                </div>
                <div id="qrcode-anestesi1_name">
                </div>
            </div>
        </div>
    </body>
    ...
    <!-- <div class=""> -->
    <script>
    const base64ttd_cetak_anestesi = <?= json_encode(@$anestesi['visit']['ttd_dok']); ?>;
    if (base64ttd_cetak_anestesi) {
        $('#qrcode-anestesi').html(
            `<img src="${base64ttd_cetak_anestesi}" alt="QR Code" style="width: 100%; max-width: 300px; height: auto;">`
        );
        $('#qrcode-anestesi-one').html(
            `<img src="${base64ttd_cetak_anestesi}" alt="QR Code" style="width: 100%; max-width: 300px; height: auto;">`
        );

        $('#qrcode-anestesi_name').html('<?=$anestesi['visit']['ttd_dokter_name']?>')
        $('#qrcode-anestesi-one_name').html('<?=$anestesi['visit']['ttd_dokter_name']?>')
    ...
    const base64ttd_cetak_anestesi_pasien = <?= json_encode(@$anestesi['visit']['ttd_pasien']); ?>;

    if (base64ttd_cetak_anestesi_pasien) {
        cropTransparentPNG(base64ttd_cetak_anestesi_pasien, (croppedImage) => {
            if (croppedImage) {
                $('#qrcode-anestesi1').html(
                    `<img src="${croppedImage}" alt="Signature" style="width: 100%; max-width: 55px; height: auto;">`
                );
                $('#qrcode-anestesi1').html('<?= $anestesi['visit']['diantar_oleh']; ?>')
