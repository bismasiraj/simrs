...
<head>
    ...
    <title>ASESMEN MEDIS PASIEN PENYAKIT PARU</title>
        ...
        <form action="<?= site_url('#') ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered mb-2" style="border: 2px solid black">
                ...
                <tr>
                    <td colspan="2">
                        <h6>TERAPI</h6>
                        <textarea class="form-control" name="v_20" id="v_20" cols="6" rows="7"></textarea>
                    </td>
                </tr>
                <tr>
                    <td width="15%">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="date" name="v_28" id="v_28">
                                    </div>
                                </div>
                            </div>
                        </div>
