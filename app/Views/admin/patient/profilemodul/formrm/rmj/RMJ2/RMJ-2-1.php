...
<body>
    <form id="form" action="/admin/rekammedis/rmj2_1/ <?= base64_encode(json_encode($visit)); ?>" method="POST">
        ...
        <div class="container mt-3">
            ...
            <br>
            <h5 style="text-align: right;"><b>RMJ.2.1</b></h5>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center;">
                            <h5><b>ASESMEN MEDIS PASIEN ANAK</b></h5>
                        </td>
                    </tr>
                ...
                <tbody>
                            ...
                            <div class="mb-3">
                                <div class="col-md-4">
                                    <div class="row text-align">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="ana_pregnancy_childbirth_history" name="ana_pregnancy_childbirth_history" style="width: 700px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="col-md-4">
                                    <div class="row text-align">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="ana_imun_history" name="ana_imun_history" style="width: 700px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="mb-3">
                                <div class="col-md-4">
                                    <div class="row text-align">
                                        <div class="col-md-6">
                                            <label for="">Riwayat Perkembangan</label>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="v_23" name="v_23" style="width: 700px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="mb-3">
                                <div class="col-md-4">
                                    <div class="row text-align">
                                        <div class="col-md-7">
                                            <label for="">Riwayat Penyakit Lain</label>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" id="ana_past_disease_history" name="ana_past_disease_history" style="width: 700px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="col-md-4">
                                    <div class="row text-align">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" id="ana_family_disease_history" name="ana_family_disease_history" style="width: 700px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="mb-3">
                                <div>
                                    <textarea class="form-control" id="ana_drugs_consumed" name="ana_drugs_consumed" rows="4" cols="7"></textarea>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        $(document).ready(function() {
            ...
            ?>
                if ("<?= $val['body_id']; ?>" != null && "<?= $val['body_id']; ?>" != '') {
                    ...
                    $("#assessment_type").val("<?= $val['assessment_type']; ?>")
                    ...
                    $("#pf_vital_sign_hc").val("<?= $val['pf_vital_sign_hc']; ?>")
                    ...
                    $("#additional_physical_exam").val("<?= $val['additional_physical_exam']; ?>")
                    ...
                    $("#age_category").val("<?= $val['age_category']; ?>")
