...
<head>
    ...
    <title>RMJ 2.2 ASSESMEN MEDIS PASIEN RAWAT JALAN KANDUNGAN</title>
</head>

<body>
    <form id="form" action="/admin/rekammedis/rmj2_2/ <?= base64_encode(json_encode($visit)); ?>" method="POST">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center;">
                            <h5><b>ASESMEN MEDIS PASIEN KEBIDANAN DAN KANDUNGAN</b></h5>
                        </td>
                    </tr>
            ...
            <table class="table table-bordered mb-0" style="border: 1px solid black;">
                <tbody>
                        ...
                        <td>
                            ...
                            <div class="mb-3">
                                <div class="col-md-3">
                                    <div class="row text-align">
                                        <div class="col-md-8">
                                            <label for="">2. Status Obsteri :</label>
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <label>3. Status Ginekologi</label>
                            <div style="text-align: center;">
                                <img src="<?= base_url('img/ovarium.png') ?>" alt="logo" width="400px">
                            </div>
                    ...
                    <tr>
                        <td>
                            <label>
                                <h5><b>D. PERENCANAAN</b></h5>
                            </label>
                            <div class="mb-3">
                                <label><b>1. Diagnostik :</b></label>
                                <div>
                                    <textarea class="form-control" id="v_24" name="v_24" rows="4" cols="7"></textarea>
                                </div>
                            </div>
                            <label><b>2. Terapi :</b></label>
                            <div class="mb-3">
                                <div>
                                    <textarea class="form-control" id="v_24" name="v_24" rows="10" cols="7"></textarea>
                                </div>
                            </div>
                        </td>
                    </tr>
