    ...
    <tbody>
        <tr>
            <td>
                <div class="mb-3">
                    <div class="col-md-3">
                        <div class="row text-align">
                            <div class="col-md-8">
                                <label for="">Status Obsteri :</label>
                            </div>
                            <div class="col-md-4">
                ...
                <label>Status Ginekologi</label>
                <div style="text-align: center;">
                    <img src="<?= base_url('assets/img/asesmen/bidan_kandungan/ovary.png') ?>" alt="logo" width="400px">
                </div>
    ...
    $(document).ready(function() {
        ...
        ?>
            if ("<?= $val['body_id']; ?>" != null && "<?= $val['body_id']; ?>" != '') {
                ...
                $("#obstetric_status").val('<?= $val['obstetric_status']; ?>')
                $("#gynecology_status").val('<?= $val['gynecology_status']; ?>')
                $("#ovary_image").val('<?= $val['ovary_image']; ?>')
                ...
                $("#biparietal_diameter").val('<?= $val['biparietal_diameter']; ?>')
                $("#femur_lengh").val('<?= $val['femur_lengh']; ?>')
                $("#afi").val('<?= $val['afi']; ?>')
                $("#fetal_weight").val('<?= $val['fetal_weight']; ?>')
                $("#estimated_delivery_date").val('<?= $val['estimated_delivery_date']; ?>')
                $("#leopold_obstetric_image").val('<?= $val['leopold_obstetric_image']; ?>')
                $("#usg_result").val('<?= $val['usg_result']; ?>')
                $("#pregnancy_case").val('<?= $val['pregnancy_case']; ?>')
