                ...
                <div class="col-md-6">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="sd_ins_location" id="sd_ins_location">
                            </div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="sd_ins_ukk" id="sd_ins_ukk">
                            </div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="sd_ins_distribution" id="sd_ins_distribution">
                            </div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="sd_ins_configuration" id="sd_ins_configuration">
                            </div>
                        </div>
                    </div>
                    <br>
                    <label for="">ii. Palpasi</label>
                    <textarea class="form-control" name="sd_palpation" id="sd_palpation" cols="6" rows="4"></textarea>
                    <br>
                    <label for="">iii. Lain-lain</label>
                    <textarea class="form-control" name="sd_others" id="sd_others" cols="6" rows="8"></textarea>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12 text-center align-items-center">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <img class="mt-3" src="<?= base_url('assets/img/asesmen/kulit/female.jpg') ?>" width="400px">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <img class="mt-3" src="<?= base_url('assets/img/asesmen/kulit/male.jpg') ?>" width="400px">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <tr>
        <td colspan="2">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" name="sv_inspection" id="sv_inspection" cols="6" rows="2"></textarea>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" name="sv_palpation" id="sv_palpation" cols="6" rows="2"></textarea>
                </div>
            </div>
        </td>
    </tr>
    ...
    $(document).ready(function() {
        ...
        ?>
            if ("<?= $val['body_id']; ?>" != null && "<?= $val['body_id']; ?>" != '') {
                ...
                $("#sd_ins_location").val("<?= $val['sd_ins_location']; ?>")
                $("#sd_ins_ukk").val("<?= $val['sd_ins_ukk']; ?>")
                $("#sd_ins_distribution").val("<?= $val['sd_ins_distribution']; ?>")
                $("#sd_ins_configuration").val("<?= $val['sd_ins_configuration']; ?>")
                $("#sd_palpation").val("<?= $val['sd_palpation']; ?>")
                $("#sd_others").val("<?= $val['sd_others']; ?>")
                $("#sv_inspection").val("<?= $val['sv_inspection']; ?>")
                $("#sv_palpation").val("<?= $val['sv_palpation']; ?>")
                ...
                $("#pf_male_image").val("<?= $val['pf_male_image']; ?>")
                $("#pf_female_image").val("<?= $val['pf_female_image']; ?>")
