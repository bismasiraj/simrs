...
<head>
    ...
    <title>ASESMEN MEDIS PASIEN PENYAKIT DALAM</title>
        ...
        <form action="<?= site_url('#') ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered mb-2" style="border: 2px solid black">
                ...
                <tr style="border: 2px solid black">
                    <td colspan="2">
                        <h5 class="text-center">ASESMEN MEDIS PASIEN PENYAKIT DALAM</h5>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-2">
                                    <strong><label class="col-form-label">KEADAAN UMUM</label></strong>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check-inline">
                                        <input type="radio" class="form-check-input" name="t_02" id="t_02_sedang" value="2">
                                        <label for="t_02_sedang">Sedang</label>
                                    </div>
                                    <div class="form-check-inline">
                                        <input type="radio" class="form-check-input" name="t_02" id="t_02_lemah" value="3">
                                        <label for="t_02_lemah">Lemah</label>
                                    </div>
                                </div>
                            </div>
                            <br>
                ...
                <tr>
                    <td colspan="2">
                        <strong><label>PEMERIKSAAN FISIK</label></strong>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3">
                                    <strong>
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-3">
                                        <img class="mt-3" src="<?= base_url('assets/rmj2_3_1.png') ?>" width="150px">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-md-3">
                                        <img class="mt-3" src="<?= base_url('assets/rmj2_3_2.png') ?>" width="150px">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <tr>
                    <td colspan="2">
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <strong><label>PEMERIKSAAN PENUNJANG</label></strong>
                            </div>
                            <div class="col-md-10">
                ...
                <tr>
                    <td colspan="2">
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <strong><label>DIAGNOSIS KERJA</label></strong>
                            </div>
                            <div class="col-md-10">
                ...
                <tr>
                    <td colspan="2">
                        <h6>TERAPI</h6>
                        <textarea class="form-control" name="v_15" id="v_15" cols="6" rows="7"></textarea>
                    </td>
                </tr>
                <tr>
                    <td width="15%">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    <div class="col-md-7">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="t_05" id="t_05_klinik" value="6">
                            ...
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="date" name="v_24" id="v_24">
                                    </div>
                                </div>
                            </div>
                        </div>
