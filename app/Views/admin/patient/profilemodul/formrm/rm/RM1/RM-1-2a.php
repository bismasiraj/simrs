...
<head>
    ...
    <title>PENILAIAN KEBUTUHAN EDUKASI TRIASE ANAK</title>
        ...
        function addRow(tableID) {
            ...
            $("#" + tableID).append($("<tr>")
                .append($("<td>").html('<div class="form-group"> \
                            <input type="date" class="form-control" id="v_' + v1 + '"name="v_' + v1 + '" >\
                        </div>'))
...
<body>
    ...
    <div class="container-fluid table-responsive">
        <table class="w-full table table-striped table-bordered table-hover mt-1 mb-1" style="border: 2px solid black; border-top: 0;">
            <thead>
                <tr class="text-center">
                    <th width="30px">Tanggal</th>
                    <th width="30px">Kebutuhan Edukasi</th>
                    <th width="30px">Tujuan</th>
                    <th width="30px">Kemampuan Belajar</th>
                    <th width="30px">Kesiapan Belajar</th>
                    <th width="30px">Hambatan</th>
                    <th width="30px">Intervensi</th>
                    <th width="30px">Metode</th>
                    <th width="30px">Hasil</th>
                    <th width="30px">Nama/TTD</th>
                </tr>
            </thead>
            <tbody id="tbody">
                <tr>
