...
<body>
    ...
    <?php 
        ...
        // echo json_encode($oprs, JSON_PRETTY_PRINT);
            ...
            ?>
                ...
                <tr>
                    ...
                    <?php
                            ...
                            foreach ($item['data_gcs'] as $index => $gcsRow) {
                    ...
                    <?php
                            ...
                            if (!empty($allColumns)) {
                                foreach ($allColumns as $i) {
                                    ...
                                    echo "<td class='text-center' colspan='2'>{$kiri}</td>";
                                    echo "<td class='text-center'>{$kanan}</td>";
                                }
                            } else {
