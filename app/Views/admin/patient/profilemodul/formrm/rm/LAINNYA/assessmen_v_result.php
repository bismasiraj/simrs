    ...
    const rendersDataView = (props) => {
        ...
        data.map((e, index) => {
            ...
            const htmlView = ` <div class="container-fluid mt-5" id="body-show-${index}">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td class="p-1" style="width:33.3%">
                                        <b>Tanggal Lahir (Usia)</b>
                                        <p id="umur-${index}" class="m-0 mt-1 p-0 ">${e?.data?.umur ?? moment("<?= $visit['tgl_lahir']?>").format("DD-MM-YYYY") }
                                        </p>
                                    </td>
                                    <td class="p-1" style="width:66.3%" colspan="2">
                                        <b>Alamat Pasien</b>
                        ...
                        <div class="subyektif" id="showSubyektif" style="display: ${statusVisibility.showSubyektif ? '' : 'none' }">
                            <div class="row">
                                <h4 class="text-start">Subyektif (S)</h4>
                            </div>
                            <table class="table table-bordered">
                        ...
                        <div class="ApgarShow" id="ApgarShow" style="display: ${statusVisibility.ApgarShow ? '' : 'none'}">
                       <div style="display: ${e.data?.apgar_score ? '' : 'none' }">
                        ...
                        <div class="obyektif">
                            ...
                            <table class="table table-bordered" id="vitailShow"
                                        style="display: ${statusVisibility.vitailShow ? '' : 'none'}">
                                        <tbody>
                                            <tr>
                                                <td colspan="4" class="fst-italic fw-bold">Vital Sign</td>
                                            </tr>
                                            ...
                                            <div class="apgar ApgarShow" id="ApgarShoww" style="display: ${statusVisibility.ApgarShow ? '' : 'none'}">
                            ...
                            <table class="table table-bordered" id="gscShow" style="display: ${statusVisibility.gscShow ? '' : 'none'}">
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="fst-italic fw-bold">GCS / Tingkat Kesadaran</td>
                                    </tr>
                            ...
                            <table class="table table-bordered" id="skalaShow"
                                style="display: ${statusVisibility.skalaShow ? '' : 'none'}">
                                <tbody>
                                    <tr>
                                        <td>
                                            <table class="table table-bordered">
                          ...
                          <div id="SarafShow" style="display: ${statusVisibility?.SarafShow ? '' : 'none'}">
                                ${e.data?.pemeriksaan_saraf ? nl2br1((e.data.pemeriksaan_saraf))  : ""}
                            </div>

                            <div id="PsikiatriShow" style="display: ${statusVisibility.PsikiatriShow ? '' : 'none'}">
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <td>
                            ...
                            <table class="table table-bordered" id="assNewShow"
                                style="display: ${statusVisibility.assNewShow ? '' : 'none'}">
                                <tbody>
                                    <tr>
                                        <td width="50%">
                                            <table class="table table-bordered text-center">
                            ...
                            <table class="table table-bordered" id="fisikShow"
                                style="display: ${statusVisibility.fisikShow ? '' : 'none'}">
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="fw-bold">Pemeriksaan Fisik Tambahan</td>
                                    </tr>
                            ...
                            <table class="table table-bordered" id="hamilShow"
                                style="display: ${statusVisibility.hamilShow ? '' : 'none'}">
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="fw-bold">Kasus Hamil</td>
                                    </tr>
                            ...
                            <table class="table table-bordered" id="statusDermatologiShow"
                                style="display: ${statusVisibility.statusDermatologiShow ? '' : 'none'}">
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="fw-bold">Status Dermatologik</td>
                                    </tr>
                        ...
                        <div class="assessment" id="AssessmentShow" style="display: ${statusVisibility.AssessmentShow ? '' : 'none'}">
                            <div class="row">
                                <h4 class="text-start">Assessment (A)</h4>
                            </div>
                            <table class="table table-bordered">
                        ...
                        <div class="planning" id="PlanningShow" style="display: ${statusVisibility.PlanningShow ? '' : 'none'}">
                            <div class="row">
                                <h4 class="text-start">Planning (P)</h4>
                            </div>
                        ...
                        <div class="RencanaAsuhandanTerapi" id="RencanaAsuhanShow"
                            style="display: ${statusVisibility.RencanaAsuhanShow ? '' : 'none'}">
                            <div class="row">
                                <h5 class="text-start">Rencana Asuhan dan Terapi</h5>
                            </div>
                            <table class="table table-bordered">
                        ...
                        <div class="RencanaTindakLanjut" id="RencanaTindakLanjutShow"
                            style="display: ${statusVisibility.RencanaTindakLanjutShow ? '' : 'none'}">
                            <div class="row">
                                <h5 class="text-start">Rencana Tindak Lanjut</h5>
                            </div>
                            <table class="table table-bordered">
