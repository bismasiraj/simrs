...
<body>
    <div class="container mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <div class="row">
                <h3 class="text-center">Pemberian Vaksinasi</h3>
            </div>
            <div class="row">
            ...
            <div class="row mb-3">
                <div class="col text-center">
                    <h3><b>SURAT PERSETUJUAN PEMBERIAN VAKSINASI</b></h3>
                </div>
            </div>
            <div class="row">
                <div class="col">Yang bertanda tangan dibawah ini</div>
            </div>
            ...
            <div class="row">
                <div class="col">Menyatakan menyetujui pemberian vaksin hepatitis B0 terhadap Pasien:</div>
            </div>
