...
<body>
    <div class="container-fluid mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <div class="row">
                <h3 class="text-center">Surat Perintah Konsultasi</h3>
            </div>
            <div class="row">
            ...
            <div class="row mb-2">
                <div class="col text-center">
                    <h3><b><u>SURAT PERINTAH KONSULTASI</u></b></h3>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <label for="sa" class="col-sm-2 col-form-label">Konsul Ke</label>
                <label for="sa" class="col-sm-auto col-form-label">:</label>
                <div class="col">
                    <input type="text" class="form-control" id="sa" name="sa" value="">
                </div>
            ...
            <div class="row mb-2">
                <label for="sa" class="col-sm-2 col-form-label">Catatan</label>
                <label for="sa" class="col-sm-auto col-form-label">:</label>
                <div class="col">
                    <input type="text" class="form-control" id="sa" name="sa" value="">
                </div>
