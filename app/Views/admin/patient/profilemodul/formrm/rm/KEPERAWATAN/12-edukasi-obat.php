...
<body>
    <div class="container mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <div class="row mb-1">
                <div class="col">
                    Nama Obat (Kandungan zat Aktif) dan Aturan Pakai:
                </div>
            </div>
            <div class="row mb-1">
                <div class="col">
                    Indikasi: <br>
                    1. Anti Emetik<br>
                    2. Gastro Protektor<br>
                    3. Vitamin, Mineral, Suplemen
                </div>
            </div>
            <div class="row mb-1">
                <div class="col">
                    Efek Samping: <br>
                    1. Pusing / Sakit Kepala<br>
                    2. Mengantuk<br>
                    3. Ustikaria / Gatal pada Kulit
                </div>
            </div>
            <div class="row mb-1">
                <div class="col">
                    Cara Penyimpanan: <br>
                    1. Simpan obat dalam etiket label<br>
                    2. Simpan di tempat kering, suhu ruangan<br>
                    3. Hindarkan dari jangkauan anak
                </div>
            </div>
            <div class="row mb-1">
                <div class="col">
                    Perhatian: <br>
                    Jika muncul reaksi alergi/reaksi efek samping yang berlebihan, hentikan penggunaan obat, segera konsultasikan ke dokter.
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
