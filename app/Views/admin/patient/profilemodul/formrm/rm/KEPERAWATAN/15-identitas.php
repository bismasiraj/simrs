...
<body>
    <div class="container-fluid mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <div class="row mb-5">
                <h1 class="text-center fw-bold">IDENTITAS DAN PERNYATAAN RAWAT INAP PASIEN</h1>
            </div>
            <div class="row">
            ...
            <div class="row mb-1">
                ...
                <div class="col">
                    <input type="text" class="form-control" id="theid" name="theid" value="">
                </div>
            </div>
            <div class="row mb-1">
                ...
                <div class="col">
                    <input type="text" class="form-control" id="status_pasien_id" name="status_pasien_id" value="">
                </div>
            </div>
            <div class="row mb-1">
                <label for="sa" class="col-sm-2 col-form-label">Agama</label>
            ...
            <div class="row mb-1">
                ...
                <div class="col">
                    <input type="text" class="form-control" id="theaddress" name="theaddress" value="">
                </div>
            </div>
            <div class="row mb-1">
                <label for="sa" class="col-sm-2 col-form-label">Telepon</label>
            ...
            <div class="row mb-1">
                <label for="sa" class="col-sm-auto col-form-label">Menghendaki Pasien tersebut di atas dirawat inap di kelas:</label>
                <label for="sa" class="col-sm-auto col-form-label">:</label>
                <div class="col">
                    <input type="text" class="form-control" id="sa" name="sa" value="">
                </div>
            ...
            <div class="row mb-5">
                <div class="col">
                    ...
                    <p>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Surat pernyataan ini saya buat atas kesadaran sendiri dan tanpa paksaan/dipengaruhi oleh siapapun. Kami mengerti dan bertanggung jawab atas segala resiko yang akan terjadi.
                    </p>
                </div>
            </div>
            <div class="row">
