            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="container">
                                <div class="row">1. Menerima pasien dari poli</div>
                                <div class="row">2. Menganamnesa pasien</div>
                                <div class="row">3. Bidan - Pemasangan Infus Dewasa</div>
                                <div class="row">4. Memasang gelang identitas</div>
                                <div class="row">5. Inj ranitidin 1a</div>
                                <div class="row">6. Inj ondancentron 8mg</div>
                                <div class="row">7. memberikan obat oral CTM</div>
                                <div class="row">8. Inj ranitidin 1a</div>
                                <div class="row">9. Inj ondancentron 8mg</div>
                                <div class="row">10. Memberikan obat oral CTM</div>
                            </div>
                        </td>
                        <td>Nur Hidayah, AMd.Keb</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container">
                                <div class="row">1. Menyambung inf RL drip N5000 30 tpm</div>
                                <div class="row">2. Anjurkan ibu makan sedikit-sedikit tapi sering</div>
                            </div>
                        </td>
                        <td>Nur Hidayah, AMd.Keb</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container">
                                <div class="row">1. Transfer pasien ke bangsal</div>
                            </div>
                        </td>
                        <td>Fitrianingsih, AM.Keb</td>
                        <td>
                            <canvas id="canvas" width="150" height="100" style="border:1px solid #000;"></canvas>
                            <input type="hidden" name="ttd" id="ttd">
                        </td>
