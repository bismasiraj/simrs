...
<body>
    <div class="container-fluid mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <b>Bed</b>
                            <input type="text" class="form-control" id="no_tt" name="no_tt" value="<?= $val['no_tt']; ?>">
                        </td>
                    </tr> -->
                </tbody>
            </table>
            <div class="row mb-1">
                <div class="col">
                    Yang bertanda tangan di bawah ini <br> Menerangkan bahwa:
                </div>
            </div>
            <div class="container px-5">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="diagnosis" name="diagnosis" value="<?= $val['diagnosa_desc']; ?>">
                    </div>
                </div>
                <div class="row mb-1">
                    ...
                    <script>
                        $("#farmakologi").html(('<?= $val['farmakologi']; ?>').replace(/\n/g, "<br>"))
                    </script>
                </div>
                <div class="row mb-1">
                    <label for="tgl_kontrol_selanjutnya" class="col-sm-3 col-form-label">Tanggal Kontrol Selanjutnya</label>
                    <label for="tgl_kontrol_selanjutnya" class="col-sm-auto col-form-label">:</label>
                    <div class="col">
                        <input type="text" class="form-control" id="tgl_kontrol_selanjutnya" name="tgl_kontrol_selanjutnya" value="<?= $val['tgl_kontrol_selanjutnya']; ?>">
                    </div>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="alasan_kontrol" name="alasan_kontrol" value="<?= $val['alasan_kontrol']; ?>">
                    </div>
                </div>
            </div>
            <div class="row mb-3">
