...
<table class="table table-bordered">
    <tbody>
        <tr>
            <td>
                <b>pGCS / Tingkat Kesadaran Anak</b>
            </td>
        </tr>
        <tr>
            <td>
                <div class="row mb-2">
                    <div class="col-auto">
                        <b>pGCS E / Respon Membuka Mata :</b>
                    </div>
                    <div class="col">
                ...
                <div class="row mb-2">
                    <div class="col-auto">
                        <b>pGCS V / Respon Verbal Terbaik (Verbal) :</b>
                    </div>
                    <div class="col">
                ...
                <div class="row mb-2">
                    <div class="col-auto">
                        <b>pGCS M / Respon Motorik Terbaik :</b>
                    </div>
                    <div class="col">
...
<table class="table table-bordered">
    <tbody>
        <tr>
            ...
            <td rowspan="3">
                <img class="mt-3" src="<?= base_url('assets/img/asesmen/anak/thorax.png') ?>" width="400px">
            </td>
        </tr>
        <tr>
            <td>
...
<table class="table table-bordered">
    <tbody>
        <tr>
            ...
            <td rowspan="4">
                <img class="mt-3" src="<?= base_url('assets/img/asesmen/anak/abdomen.png') ?>" width="400px">
            </td>
        </tr>
        <tr>
            <td>
