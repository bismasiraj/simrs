            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        ...
                        <td rowspan="3">
                            <img class="mt-3" src="<?= base_url('assets/img/asesmen/bedah/thorax.png') ?>" width="400px">
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        ...
                        <td rowspan="4">
                            <img class="mt-3" src="<?= base_url('assets/img/asesmen/bedah/abdomen.png') ?>" width="400px">
                        </td>
                    </tr>
                    <tr>
                        <td>
