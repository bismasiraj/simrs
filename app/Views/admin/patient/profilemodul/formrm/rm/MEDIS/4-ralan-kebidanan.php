            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <b>Keadaan Umum</b>
                            <input type="text" class="form-control" id="pf_general_condition" name="pf_general_condition" value="">
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td colspan="2">
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control" id="pregnancy_case" name="pregnancy_case" value="">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <b>Stasus Obstetri</b>
                            <input type="text" class="form-control" id="obstetric_status" name="obstetric_status" value="">
                        </td>
                        <td>
                            <b>Status Ginekologi</b>
                            <input type="text" class="form-control" id="gynecology_status" name="gynecology_status" value="">
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td>
                            <b>Farmakoterapi</b>
                            <div type="text" class="form-control" id="farmakologia" name="farmakologia"><?= $val['farmakologia']; ?></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <b>Procedure</b>
                            <div type="text" class="form-control" id="prosedur" name="prosedur"><?= $val['prosedur']; ?></div>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <div type="text" class="form-control" id="follow_up_plan" name="follow_up_plan"></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <b>Kontrol</b>
                            <div type="text" class="form-control" id="rtj_control" name="rtj_control"></div>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <div type="text" class="form-control" id="patient_education" name="patient_education"></div>
                        </td>
                    </tr>
                </tbody>
            </table>
