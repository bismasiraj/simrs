    ...
    <div class="container mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <b>Department</b>
                            <input type="text" class="form-control" id="departemen" name="departemen" value="<?= $val['department']; ?>">
                        </td>
                        <td>
                            <b>Tanggal Masuk</b>
            ...
            <div class="row mb-1">
                ...
                <div class="col">
                    <input type="text" class="form-control" id="date_of_birth" name="date_of_birth" value="<?= $val['date_of_birth']; ?> (<?= $val['umur']; ?>)">
                </div>
            </div>
            <div class="row mb-1">
