    ...
    <div class="container-fluid mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td colspan="2" width="50%"><b>Vital Sign</b></td>
                        <td><b>Oculus Dextra/Sinistra</b></td>
                    </tr>
                    <tr>
                        <td>
                            <b>Tekanan Darah</b>
                        ...
                        <td rowspan="4">
                            <img class="mt-3" src="<?= base_url('assets/img/asesmen/mata/oculus.jpg') ?>" width="400px">
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td><b>Funduscopy</b></td>
                        <td>
                            <img class="mt-3" src="<?= base_url('assets/img/asesmen/mata/funduscopy.jpg') ?>" width="400px">
                        </td>
                    </tr>
                </tbody>
            </table>
