        ...
        <form action="<?= site_url('#') ?>" method="post" autocomplete="off">
                            ...
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row align-items-center">
                                            <div class="col-md-6">
                                                <input type="radio" class="form-check-input" name="t_08" id="t_08_autoanamnesis" value="2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" type="text" name="v22" id="v22">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" type="text" name="26" id="26">
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col-md-3">
            ...
            <table class="table table-bordered mt-0 mb-5" style="border:2px solid black; border-bottom:0; border-top:0">
                <tr>
                    ...
                    <td colspan="3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="t_012_rj" name="t_012" value="1">
                            <label for="t_012_rj">Rawat Jalan</label>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="t_012_ri" name="t_012" value="2">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="t_013_observasi" name="t_013" value="1">
                                    <label for="t_013_observasi">Observasi, keluar dari RS</label>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="t_013_rujuk" name="t_013" value="2">
                                    <label for="t_013_rujuk">Rujuk ke :</label>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="t_014_rs" name="t_014" value="1">
                                            <label for="t_014_rs">RS</label>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="t_014_dokter" name="t_014" value="2">
                                            <label for="t_014_dokter">Dokter Keluarga</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="t_014_puskesmas" name="t_014" value="3">
                                            <label for="t_014_puskesmas">Puskesmas</label>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="t_014_homecare" name="t_014" value="4">
                                            <label for="t_014_homecare">Homecare</label>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_015_kamar" name="t_015" value="1">
                                        <label for="t_015_kamar">Kamar Penuh</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_015_keluarga" name="t_015" value="2">
                                        <label for="t_015_keluarga">Permintaan Pasien/Keluarga</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_015_fasilitas" name="t_015" value="3">
                                        <label for="t_015_fasilitas">Perlu fasilitas / SDM</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_016_ambulanrs" name="t_016" value="1">
                                        <label for="t_016_ambulanrs">Ambulan RS</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_016_amblanlain" name="t_016" value="2">
                                        <label for="t_016_amblanlain">Ambulan Lain</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_016_kendaraan" name="t_016" value="3">
                                        <label for="t_016_kendaraan">Kendaraan umum</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="t_016_pribadi" name="t_016" value="4">
                                        <label for="t_016_pribadi">Pribadi</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="t_017_pasien" name="t_017" value="1">
                            <label for="t_017_pasien">Pasien</label>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="t_017_keluarga" name="t_017" value="2">
                                    <label for="t_017_keluarga">Keluarga Pasien, nama : </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-7">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="t_017_tidak" name="t_017" value="3">
                                    <label for="t_017_tidak">Tidak dapat memberikan edukasi kepada pasien / keluarga pasien*, karena</label>
                                </div>
                            </div>
                            <div class="col-md-5">
