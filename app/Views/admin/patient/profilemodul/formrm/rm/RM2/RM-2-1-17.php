            ...
            <table class="table table-bordered border-black">
                ...
                <tr>
                    <td>
                        ...
                        <div class="row">
                            <label for="V_76" class="col-sm-auto col-form-label">Rekapitulasi Asesmen dibuat tanggal :</label>
                            <div class="col-sm-4">
                                <input type="date" class="form-control" id="V_76" name="V_76">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row mb-1">
                            <div class="col">
                                V. REKOMENDASI
                                <textarea class="form-control" name="V_81" id="V_81" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col" style="text-align:center">
                                ...
                                ( <input type="text" id="V_82" name="V_82" style="width:250px; text-align: center;"> )<br>
