...
<head>
    ...
    <title>ASSESSMENT MEDIS PASIEN BEDAH</title>
            ...
            <table class="table table-bordered mb-2" style="border: 2px solid black">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <textarea class="form-control" name="v_23" id="v_23" cols="6" rows="3"></textarea>
                        ...
                        <br>
                        <h6>SASARAN</h6>
                        <textarea class="form-control" name="v_27" id="v_27" cols="6" rows="2"></textarea>
