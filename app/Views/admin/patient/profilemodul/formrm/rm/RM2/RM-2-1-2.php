...
<head>
    ...
    <title>ASESMEN MEDIS PASIEN KEBIDANAN DAN KANDUNGAN</title>
        ...
        <form action="<?= site_url('#') ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered mb-2" style="border: 2px solid black">
                ...
                <tr style="border: 2px solid black">
                    <td colspan="3">
                        <h5 class="text-center">ASESMEN MEDIS PASIEN KEBIDANAN DAN KANDUNGAN</h5>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <h6>B. PEMERIKSAAN FISIK</h6>

                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <strong><label>1. Keadaan Umum</label></strong>
                                </div>
                                <div class="col-md-9">
                        ...
                        <h6>C. DIAGNOSIS</h6>
                        <div class="container">
                            <h6>1. Diagnosa Kerja</h6>
                            <textarea class="form-control" name="v_13" id="v_13" cols="6" rows="2"></textarea>

                            <br>
                            <h6>2. Diagnosa Banding</h6>
                            <textarea class="form-control" name="v_14" id="v_14" cols="6" rows="2"></textarea>
                            ...
                            <div class="container">
                                ...
                                <textarea class="form-control" name="v_15" id="v_15" cols="6" rows="2"></textarea>
                                <strong>
                                    <p>2. Keperawatan</p>
                                </strong>
                        ...
                        <br>
                        <h6>2. SASARAN</h6>
                        <textarea class="form-control" name="v_21" id="v_21" cols="6" rows="3"></textarea>
                        <br>
                        <h6>3. RENCANA ASUHAN/ TERAPI/INSTRUKSI (standing order)</h6>
                        <textarea class="form-control" name="v_22" id="v_22" cols="6" rows="15"></textarea>
                        <br>
                        <br>
                        <br>
