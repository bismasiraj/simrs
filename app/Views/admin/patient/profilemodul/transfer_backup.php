                ...
                <div class="card-body">
                    ...
                    <form id="formaddatransfer" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="isinternal" id="atransferisinternal" onchange="tindakLanjut(this.value)" class="form-control ">
                        ...
                        <div class="panel-footer text-end mb-4">
                            ...
                            <button type="button" id="formeditatransferid" name="editrm" onclick="enableTindakLanjut()" data-loading-text="<?php echo lang('processing') ?>" class="btn btn-secondary pull-right formeditatransfer"><i class="fa fa-edit"></i> <span>Edit</span></button>
                    ...
                    <div class="card-body">
                        <form id="formaddatransfer1" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="panel-footer text-end mb-4">
                                    <button type="submit" id="formSaveatransfer1btnid" name="save" data-loading-text="<?php echo lang('processing') ?>" class="btn btn-primary pull-right formsaveatransfer1btn"><i class="fa fa-check-circle"></i> <span>Simpan</span></button>
                    ...
                    <div class="card-body">
                        <form id="formaddatransfer2" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="panel-footer text-end mb-4">
                                    <button type="submit" id="formsaveatransfer2btnid" name="save" data-loading-text="<i class='fas fa-spinner fa-pulse'></i> Proses ..." class="btn btn-primary pull-right formsaveatransfer2btn"><i class="fa fa-check-circle"></i> <span>Simpan</span></button>
                                    <button type="button" id="formeditatransfer2id" name="editrm" onclick="enabletransfer2()" data-loading-text="<i class='fas fa-spinner fa-pulse'></i> Proses ..." class="btn btn-secondary pull-right formeditatransfer2"><i class="fa fa-edit"></i> <span>Edit</span></button>
                                    <button type="button" id="formsignatransfer2id" name="signrm" onclick="signatransfer2()" data-loading-text="<i class='fas fa-spinner fa-pulse'></i> Proses ..." class="btn btn-warning pull-right formsignatransfer2"><i class="fa fa-signature"></i> <span>Sign</span></button>
