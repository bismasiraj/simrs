...
<!-- Modal -->
<div class="modal fade modal-xl" id="modalExpertise" aria-labelledby="ModalLabelExpertise" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="" id="formExpertise" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <div class="mb-2">
                                    ...
                                    <input type="text" id="modalNoFilm" class="form-control" name="no_film" <?= user()->checkPermission("rad", 'c') && user()->checkRoles(['dokterradiologi', 'superuser']) ? '' : 'disabled'; ?>>
                                </div>
                                <div class="mb-2">
                                    <label for="modalHasilBaca" class="form-label fw-bold">Hasil Baca</label>
                                    <textarea class="form-control" id="modalHasilBaca" name="hasil_baca" rows="3" <?= user()->checkPermission("rad", 'c') && user()->checkRoles(['dokterradiologi', 'superuser']) ? '' : 'disabled'; ?>></textarea>
                                </div>
                                <div class="mb-2">
                                ...
                                <?php if (user()->checkPermission("rad", 'c') && user()->checkRoles(['dokterradiologi', 'superuser'])) : ?>
                                    <div class="mb-2">
                                        <input type="hidden" name="isvalid" value="0" id="modalIsValid">
                                        <input type="hidden" name="iskritis" value="0" id="modalIsKritis">
                                        <div class="d-flex gap-2">
                                            <button type="button" class="btn btn-outline-primary" id="isValidExpertise">Validasi</button>
                                            <button type="button" class="btn btn-outline-primary" id="isKritisExpertise">Nilai Kritis</button>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-2 p-1 border border-1 border-dark rounded" style="height: auto; width:100%;">
                                <img id="imagePreviewExpertise" src="#" alt="Image Preview" style="display: none; max-width: 100%; height: auto;" />
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <?php endif; ?>
                    <button id="batalExpertise" type="button" class="btn btn-danger">Batalkan Tagihan</button>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea class="form-control" id="modalTemplateKesimpulan" rows="3" readonly></textarea>
                            </div>
                        </div>
                    </div>
                </div>
