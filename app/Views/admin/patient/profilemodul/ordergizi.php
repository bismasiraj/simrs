        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="panel-footer text-end mb-4">
                    <button type="button" id="saveBentukGizi" name="save" data-loading-text="<?php echo lang('processing') ?>" class="btn btn-primary pull-right"><i class="fa fa-check-circle"></i> <span>Pilih</span></button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="panel-footer text-end mb-4">
                    <button type="button" id="savePeringatanGizi" name="save" data-loading-text="<?php echo lang('processing') ?>" class="btn btn-primary pull-right"><i class="fa fa-check-circle"></i> <span>Pilih</span></button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div>
