            ...
            <div class="container-fluid">
                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td class="p-1" style="width:33.3%">
                                <b>Nama Pasien</b>
                                <p class="m-0 mt-1 p-0"><?= @$visit['visit']['diantar_oleh']; ?></p>
                            </td>
                            <td class="p-1" style="width:33.3%">
                                <b>Jenis Kelamin</b>
                                <p class="m-0 mt-1 p-0">
                                    <?= @$visit['visit']['gender'] == 2 ? 'Perempuan' : 'Laki-Laki'; ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td class="p-1" style="width:33.3%">
                                ...
                                <p class="m-0 mt-1 p-0">
                                    <?= tanggal_indo($visit['visit']['tgl_lahir']) . ' (' . @$visit['visit']['age'] . ')'; ?>
                                </p>

                            </td>
                            <td class="p-1" style="width:66.3%" colspan="2">
                                <b>Alamat Pasien</b>
                                <p class="m-0 mt-1 p-0"><?= @$visit['visit']['visitor_address']; ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td class="p-1" style="width:33.3%">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th width="20%">
                            <?= 'Tanggal: ' . tanggal_indo(date_format(date_create($data4['modified_date']), 'Y-m-d')); ?>
                        </th>
                        <th width="20%"><?= 'Jam : ' . date_format(date_create($data4['modified_date']), 'H:i'); ?>
                        </th>
                    </tr>
                </table>
                ...
                <table class="table table-bordered">
                    <!-- <thead> -->
                    <tr>
                        <th colspan="4" class="text-center">Beri tanda (√) pada pilihan data risiko yang sesuai:
                        </th>
                    </tr>
                    <tr>
                        <th width="1%">No</th>
                    ...
                    <tr>
                        ...
                        <td class="py-0" width="1%">
                            <?= (trim(strip_tags($row['value_info'])) !== '') ? '&#10003;' : ''; ?>
                        </td>
                        <td class="py-0" width="59%">
                            <?php
                                        $isEmpty = empty($row['value_info']) || trim(strip_tags($row['value_info'])) === '';
                                        if ($row['value_score'] == 4 && !$isEmpty) {
                                            echo 'Risiko Lain-lain '. $row['value_info'];
                                        } else {
                                            echo $row['value_desc'];
                                        }
                                    ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="py-0" width="1%"><?= $key + 1; ?></td>
                        <td class="py-0" width="1%">
                            <?= empty($row['value_info']) ? $row['value_info'] : '&#10003;'; ?></td>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="py-0" width="15%">
                            <?= date_format(date_create($data4['modified_date']), 'd-m-Y H:i'); ?></td>
                        <td class="py-0" width="35%"><?= $data4['implementasi']; ?></td>
                        <td class="py-0" width="35%"><?= $data4['catatan']; ?></td>
                        <td class="py-0" width="15%"><?= $data4['modified_by']; ?></td>
                    </tr>
                    <?php endif; ?>
                    <!-- </tbody> -->
                </table>
