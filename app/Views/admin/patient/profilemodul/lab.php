                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="startDateLab" class="form-control   dateflatpickr">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="endDateLab">End Date</label>
                                                        <input type="text" id="endDateLab" class="form-control   dateflatpickr">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group pt-2">
                                                            <button type="button" id="btn-search-lab" class="btn btn-primary  " name="cari"> <i class="fa fa-search"></i>Cari</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <button type="button" class="btn btn-primary   addcharges align-items-end" onclick='addBillLab("searchTarifLab")'>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <label for="startDateLIS" class="form-label">Start
                                                                    Date</label>
                                                                <input type="text" id="startDateLIS" class="form-control   dateflatpickr">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <label for="endDateLIS" class="form-label">End
                                                                    Date</label>
                                                                <div class="d-flex">
                                                                    <input type="text" id="endDateLIS" class="form-control   dateflatpickr">
                                                                </div>
                                                            </div>
                                                            <!-- Search Button -->
                                                            <div class="col-md-2 mb-3 pt-4">
                                                                <button type="button" class="btn btn-primary  " id="searchLIS">
                                                            ...
                                                            <?php if (user()->checkPermission("lab", 'c') && user()->checkRoles(['dokterlab', 'superuser', 'adminlab'])) { ?>
                                                                <div class="col-md-4 mb-3 pt-4">
                                                                    <input class="form-check-input" type="checkbox" id="citoCheckbox" name="citoCheckbox">
                                                                    <label class="form-check-label" for="citoCheckbox">Cito</label>
                                                                </div>
                                                            <?php } ?>
                                        ...
                                        <?php if (user()->checkPermission("lab", 'c') && user()->checkRoles(['dokterlab', 'superuser', 'adminlab'])) { ?>
                                            <div class="row mt-3">
                                                <div class="col-12 text-end">
                                                    <button type="button" class="btn btn-success" id="saveLabLIS">Save</button>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </form>
                                            ...
                                            <div class="controls">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 ">
                                                        <label for="startDateLIS" class="form-label">Start
                                                            Date</label>
                                                        <input type="date" id="startDateLISHasil" name="startDateLIS" class="form-control   dateflatpickr">
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 ">
                                                        <label for="endDateLIS" class="form-label">End
                                                            Date</label>
                                                        <div class="d-flex">
                                                            <input type="date" id="endDateLISHasil" name="endDateLIS" class="form-control   me-3 dateflatpickr">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            <select id="searchTarifLabHasil" class="form-control fit" style="width: 100%;"></select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="btn-search-lab"></label>
                                                            <div class="input-group pt-2">
                                                                <button type="button" id="searchLISHasil" class="btn btn-primary" name="cari"> <i class="fa fa-search"></i> Cari</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="bloodrequest-lab-tab">
                                <div class="container-fluid">
                                                ...
                                                <div class="controls">
                                                    <form id="labBloodRequestForm" method="post">
                                                        <div class="row">
                                                            <!-- Filter Input -->
                                                            <div class="col-md-3 mb-3">
                                                                <label for="filterBloodRequest" class="form-label">Filter</label>
                                                                <select name="visit_id" id="filterBloodRequest" class="form-select">
                                                                    <option value="<?= $visit['visit_id']; ?>"><?= $visit['diantar_oleh']; ?></option>
                                                                    <option value="">SEMUA PASIEN</option>
                                                                </select>
                                                            </div>
                                                            <!-- Start Date Input -->
                                                            <div class="col-md-3 mb-3">
                                                                <label for="startDateBloodRequest" class="form-label">Start Date</label>
                                                                <input type="text" name="start_date" id="startDateBloodRequest" class="form-control dateflatpickr">
                                                            </div>
                                                            <!-- End Date Input -->
                                                            <div class="col-md-3 mb-3">
                                                                <label for="endDateBloodRequest" class="form-label">End Date</label>
                                                                <div class="d-flex">
                                                                    <input type="text" name="end_date" id="endDateBloodRequest" class="form-control   dateflatpickr">
                                                                </div>
                                                            </div>
                                                            <!-- Search Button -->
                                                            <div class="col-md-2 mb-3 pt-4">
                                                                <button type="button" class="btn btn-primary" id="searchBloodRequest">
                                                                    <i class="fa fa-search"></i> Cari
                                                                </button>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="data-table">
                                                <form action="" method="post" id="formBloodRequest-Lab">
                                                    <table class="table table-sm table-striped" id="tableFormBloodRequest-Lab">
                                                        <thead>
                                                            <tr class="table-primary">
                                                                <th class="text-center align-middle" style="width:1%"><input type="checkbox" class="form-check-input" id="bloodrequest_checkbox"></th>
                                                                <th class="text-center align-middle">Nama Pasien</th>
                                                                <th class="text-center align-middle" style="width:1%; min-width: 150px;">Jenis Darah</th>
                                                                <th class="text-center align-middle" style="width:1%">Jumlah</th>
                                                                <th class="text-center align-middle" style="width:1%">Satuan Ukuran</th>
                                                                <th class="text-center align-middle" style="width:1%">Golongan Darah</th>
                                                                <th class="text-center align-middle">Diagnosa Sementara</th>
                                                                <th class="text-center align-middle" style="width:1%; min-width: 100px;">Waktu Permintaan</th>
                                                                <th class="text-center align-middle" style="width:1%; min-width: 100px;">Waktu Penggunaan</th>
                                                                <th class="text-center align-middle">Calf Number</th>
                                                                <th class="text-center align-middle">Waktu Pengantaran</th>
                                                            </tr>
                                                        </thead>
                                    ...
                                    <?php if (user()->checkPermission("lab", 'c') && user()->checkRoles(['dokterlab', 'superuser', 'adminlab'])) { ?>
                                        <div class="row mt-3">
                                            <div class="col-12 text-end">
                                                <button type="button" class="btn btn-primary" id="saveLabBloodRequest">Save</button>
                                            </div>
                                        </div>
                                    <?php } ?>
                        ...
                        <div class="mb-2">
                            <?php if (user()->checkPermission("lab", 'c') && user()->checkRoles(['dokterlab', 'superuser', 'adminlab'])) { ?>
                                <label for="formFileBridge" class="form-label fw-bold">Upload berkas pendukung
                                    (optional)</label>
                                <input class="form-control" type="file" id="formFileBridge" name="dokumen_Bridge" accept="image/*,application/pdf">
                            <?php } ?>
                        </div>
                        <div class="mb-2">
                            <img id="imagePreviewBridge" src="#" alt="Image Preview" style="display: none; max-width: 700px; height: 700px;" />
                            <embed id="pdfPreviewBridge" type="application/pdf" style="display: none; width: 100%; height: 500px;" />
