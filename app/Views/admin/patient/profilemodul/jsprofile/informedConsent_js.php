...
(function() {
    ...
    const getDataParameter = () => {
        return new Promise((resolve, reject) => {
            let visit = <?= json_encode($visit['visit_id']); ?>;

            getDataList(`admin/InformedConsent/getDataAssesment/${visit}`, (res) => {
                if (res) {
                    aPramInf = res?.aPram;
                ...
                if (parseInt(props.code) === 1) {
                    ...
                    if (filtersName.includes("jenis kelamin") || filtersName.includes("kelamin")) {
                        ...
                        valueResult = familyAction?.job_id
                            ...
                            "terhadap")) {
                        valueResult = familyAction?.isresponsible
                    ...
                    htmlContent =
                        `<input class="form-control datetime-input" type="datetime-local" id="value_info-${props.valueId}" name="value_info-${props.valueId}" value='${valueResult}'>`;
                    resolve(htmlContent);
