...
<script>
    function addBillChargePerawat(container, type, flag = 1, index, tableId) {
        ...
        $("#perawatTindakan" + key)
            ...
            .append('<input id="atpembalace' + key + '" type="hidden" name="embalace[]">')
            ...
            .append('<input id="atpprint_date' + key + '" type="hidden" name="print_date[]">')
            .append('<input id="atpresep_no' + key + '" type="hidden" name="resep_no[]">')
            .append('<input id="atpresep_ke' + key + '" type="hidden" name="resep_ke[]">')
            .append('<input id="atpdose' + key + '" type="hidden" name="dose[]">')
            .append('<input id="atporig_dose' + key + '" type="hidden" name="orig_dose[]">')
            .append('<input id="atpdose_presc' + key + '" type="hidden" name="dose_presc[]">')
            .append('<input id="atpiter' + key + '" type="hidden" name="iter[]">')
            .append('<input id="atpiter_ke' + key + '" type="hidden" name="iter_ke[]">')
            .append('<input id="atpsold_status' + key + '" type="hidden" name="sold_status[]">')
            .append('<input id="atpracikan' + key + '" type="hidden" name="racikan[]">')
            ...
            .append('<input id="atpbrand_id' + key + '" type="hidden" name="brand_id[]">')
            .append('<input id="atpdoctor' + key + '" type="hidden" name="doctor[]">')
            .append('<input id="atpjml_bks' + key + '" type="hidden" name="jml_bks[]">')
            ...
            .append('<input id="atpserial_nb' + key + '" type="hidden" name="serial_nb[]">')
            ...
            .append('<input id="atpcorrection_id' + key + '" type="hidden" name="correction_id[]">')
            .append('<input id="atpcorrection_by' + key + '" type="hidden" name="correction_by[]">')
            ...
            .append('<input id="atpnumer' + key + '" type="hidden" name="numer[]">')
            .append('<input id="atpmeasure_id2' + key + '" type="hidden" name="measure_id2[]">')
            ...
            .append('<input id="atpstatus_obat' + key + '" type="hidden" name="status_obat[]">')
            .append('<input id="atpsubsidisat' + key + '" type="hidden" name="subsidisat[]">')
            .append('<input id="atpprintq' + key + '" type="hidden" name="printq[]">')
            .append('<input id="atpprinted_by' + key + '" type="hidden" name="printed_by[]">')
            .append('<input id="atpstock_available' + key + '" type="hidden" name="stock_available[]">')
            ...
            .append('<input id="atppackage_id' + key + '" type="hidden" name="package_id[]">')
