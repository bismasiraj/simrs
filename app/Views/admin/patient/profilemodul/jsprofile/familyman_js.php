<script type="text/javascript">
    (function() {
        ...
        const templateFamilyman = (props) => {
            const contentShow = [{
                ...
                },
                {
                    ...
                    type: "hidden",
                    name: "isresponsible",
                    value: props?.data?.isresponsible ?? 0,
                ...
                },
                {
                    ...
                    value: props?.data?.date_of_birth ?
                        moment(props?.data?.date_of_birth).format("YYYY-MM-DD") : "2000-01-01",
        ...
        const renderDataTabelsTreatIntensive = (props) => {
                ...
                resultTables += `
                        <tr>
                            ...
                            <td class="d-flex justify-content-start">
                                ...
                                <button type="button" ${e?.isresponsible === 1 || e?.isresponsible === "1" ? "Disabled" : ""} class="btn btn-outline-warning
                                    checkbox-toggle pull-right w-50 active-family" data-id="${e?.family_id}" data-org_unit_code="${e?.org_unit_code}" data-no_registration="${e?.no_registration}" >
                                    <i class="fas fa-check"></i> ${e?.isresponsible === 1 || e?.isresponsible === "1" ? "Active" : "No Active"  }
                                </button>
            ...
            actionBtnActiveFamily()
        };

        const actionBtnActiveFamily = (props) => {
            $(".active-family").off().on("click", function() {
                const id = $(this).data("id");
                const org_unit_code = $(this).data("org_unit_code");
                const no_registration = $(this).data("no_registration");
        ...
        const updateActiveFamily = (props) => {
            postData(props, 'admin/Familyman/saveData', (res) => {
                // if (response.success) {
                getDataTablesFamilyman({
                    no_registration: props?.no_registration
                })
