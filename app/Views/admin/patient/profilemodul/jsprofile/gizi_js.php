<script type="text/javascript">
    (function() {
        ...
        const countScoreAndDescription = (props) => {
            ...
            switch (props?.p_type) {
                case 'GIZ0601':
                    description = score === 0 ? '<span class="badge bg-success">Rendah</span>' : (score >= 1 && score <= 3 ? '<span class="badge bg-warning">Sedang</span>' : (score >= 4 && score <= 5 ? '<span class="badge bg-danger">Tinggi</span>' : '<span class="badge bg-light">-</span>'));
                    break;
                case 'GIZ0602':
                    description = score >= 2 ? '<span class="badge bg-danger">Berisiko malnutrisi</span>' : '<span class="badge bg-success">Tidak berisiko malnutrisi</span>';
                    break;
                case 'GIZ0603':
                    description = score >= 12 ? '<span class="badge bg-success">Normal / tidak berisiko, tidak membutuhkan pengkajian lebih lanjut</span>' : '<span class="badge bg-danger">Mungkin malnutrisi, membutuhkan pengkajian lebih lanjut</span>';
                    break;
                default:
