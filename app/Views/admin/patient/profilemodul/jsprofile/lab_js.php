...
<script type='text/javascript'>
    ...
    function addBillLab(container) {
        ...
        $("#labChargesBody")
            .append('<input name="treatment[]" id="alabtreatment' + key + vactionation_id + '" type="hidden" value="' + tarifData.tarif_name + '" class="form-control" />')
        ...
        $("#" + key)
            ...
            .append('<input name="nota_no[]" id="alabnota_no' + key + '" type="hidden" value="" class="form-control" />')
