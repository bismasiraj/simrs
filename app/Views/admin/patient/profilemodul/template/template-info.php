        ...
        <table class="table table-border mb-0">
            ...
            <tbody>
                <tr style="height: 58.5625px;">
                    <td rowspan="4" style="border-right: .5px solid #dee2e6 !important; border-top: none; vertical-align:middle;">
                        <strong>PERSETUJUAN &nbsp;/PENOLAKAN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TINDAKAN
                            KEDOKTERAN</strong>
                    </td>
                    <td style="border: none;">Nama</td>
                    <td style="border: none;">:</td>
                    <td colspan="4" style="border: none;"><?= $visit['visit']['name_of_pasien']; ?></td>
                </tr>
                <tr style="height: 36.1719px;">
                    <td style="border: none;">Tanggal lahir</td>
                    <td style="border: none;">:</td>
                    <td colspan="4" style="border: none;"><?= $visit['visit']['date_of_birth']; ?></td>
                </tr>
                <tr style="height: 36.1719px;">
                ...
                <tr style="height: 36.1719px; border-top: .5px solid #dee2e6 !important;">
                    ...
                    <td style="border: none;">:</td>
                    <td style="border: none;"><?= $visit['visit']['name_of_gender']; ?></td>
