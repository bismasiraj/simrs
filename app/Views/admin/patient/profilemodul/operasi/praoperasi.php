<div class="tab-pane fade" id="pra-operasi">
    <form id="formPraOperasi" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post">
        ...
        <input id="apovisit_id" name="visit_id" placeholder="" type="hidden" class="form-control block"
            value="<?= $visit['visit_id']; ?>" />
        <input id="apoorg_unit_code" name="org_unit_code" placeholder="" type="hidden" class="form-control block"
            value="<?= $visit['org_unit_code']; ?>" />
        <input id="apobody_id" name="body_id" placeholder="" type="hidden" class="form-control block" value="" />
        <input id="apotrans_id" name="trans_id" placeholder="" type="hidden" class="form-control block"
                    ...
                    <div class="accordion-body">
                        <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                            <div class="form-group">
                                <label class="fw-bold">Tanggal dan Jam Operasi</label>
                                <div class="position-relative">
                                    <input name="examination_date" id="apoexamination_date" type="hidden"
                                        class="form-control" value="">
                                    <input class="form-control datetimeflatpickr-oprs" type="text"
                                        id="flatapoexamination_date">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 mt-2">
                            <div class="form-group"><label class="fw-bold">Riwayat Alergi Non Obat</label>
                                <span id="aporiwayatnonobat"></span>
                                <!-- <textarea name="riwayatnonobat" id="aporiwayatnonobat" placeholder="" value=""
                                    class="form-control"></textarea> -->
                            </div>
                        </div>
                        <div class="col-sm-12 mt-2">
                            <div class="form-group"><label class="fw-bold">Riwayat Alergi Obat</label>
                                <span id="aporiwayatobat"></span>
                                <!-- <textarea name="riwayatobat" id="aporiwayatobat" placeholder="" value="" class="form-control"></textarea> -->
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                            <div class="form-group">
                                <label class="fw-bold">Hasil Pemeriksaan Penunjang</label>
                                <div class="position-relative">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                                <div class="form-group">
                                    <label class="fw-bold">Rencana Operasi</label>
                                    <div class=" position-relative">
                                        <span id="operation_planning"></span>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                                <div class="form-group">
                                    <label class="fw-bold">Mulai Operasi</label>
                                    <div class=" position-relative">
                                        <input name="start_operation" id="apostart_operation" type="hidden"
                                            class="form-control" value="">
                                        <input class="form-control datetimeflatpickr-oprs" type="text"
                                            id="flatapostart_operation">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                                <div class="form-group">
                                    <label class="fw-bold">Akhir Operasi</label>
                                    <div class=" position-relative">
                                        <input name="end_operation" id="apoend_operation" type="hidden"
                                            class="form-control" value="">
                                        <input class="form-control datetimeflatpickr-oprs" type="text"
                                            id="flatapoend_operation">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="apo<?= $value1['value_id']; ?>"
                                        name="" value="1">
                                    <label for="apo<?= $value1['value_id']; ?>"><?= $value1['value_desc']; ?></label>
                                </div>
                            </div>
                            <?php
                            }
