<div class="tab-pane fade" id="checklist-keselamatan">
    <form action="" id="form-checklist-keselamatan">
        <input type="hidden" name="org_unit_code" id="org_unit_code_checklist_keselamatan"
        ...
        <div class="col-12 my-3 d-flex justify-content-end gap-2">
            ...
            <button type="button" id="btn-save-checklist-keselamatan"
...
$('#btn-save-checklist-keselamatan').on('click', function(e) {
    ...
    let checkKeselamatanBodyID = $("#body_id_checklist_keselamatan").val();
    if (!checkKeselamatanBodyID) {
