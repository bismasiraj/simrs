<div class="tab-pane fade" id="informasi-post-operasi">
    <form action="" id="form-informasi-post-operasi">
        <input type="hidden" name="org_unit_code" id="org_unit_code_informasi-post-operasi" value="<?= $visit['org_unit_code'] ?>">
        ...
        <input type="hidden" name="body_id" id="body_id_informasi-post-operasi">
        <div id="accordionInformasiMedis" class="accordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-heading-informasi-medis">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-informasi-medis" aria-expanded="false" aria-controls="flush-collapse-informasi-medis">
                        Informasi Medis
                    </button>
                </h2>
                <div id="flush-collapse-informasi-medis" class="accordion-collapse collapse" aria-labelledby="flush-heading-informasi-medis" data-bs-parent="#accordionInformasiMedis">
        ...
        <div class="col-12 my-3 d-flex justify-content-end gap-2">
            <button type="button" id="btn-save-informasi-post-operasi" class="btn btn-primary btn-save-operasi">Simpan</button>
        </div>
    </form>
</div>
