                    ...
                    <div class="card-body">
                        <form id="formvitalsign-laporanAnesthesi" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post" class="ptt10">
                            <div class="modal-body pt0 pb0">
                                <input id="avtclinic_id-laporanAnesthesi" name="clinic_id" placeholder="" type="hidden" class="form-control block" value="<?= $visit['clinic_id']; ?>" />
                                <input id="avtclass_room_id-laporanAnesthesi" name="class_room_id" placeholder="" type="hidden" class="form-control block" value="<?= $visit['class_room_id']; ?>" />
                                <input id="avtbed_id-laporanAnesthesi" name="bed_id" placeholder="" type="hidden" class="form-control block" value="<?= $visit['bed_id']; ?>" />
                                <input id="avtkeluar_id-laporanAnesthesi" name="keluar_id" placeholder="" type="hidden" class="form-control block" value="<?= $visit['keluar_id']; ?>" />
                                <input id="avtemployee_id-laporanAnesthesi" name="employee_id" placeholder="" type="hidden" class="form-control block" value="<?= $visit['employee_id']; ?>" />
                                <input id="avtno_registration-laporanAnesthesi" name="no_registration" placeholder="" type="hidden" class="form-control block" value="<?= $visit['no_registration']; ?>" />
                                <input id="avtvisit_id-laporanAnesthesi" name="visit_id" placeholder="" type="hidden" class="form-control block" value="<?= $visit['visit_id']; ?>" />
                                <input id="avtorg_unit_code-laporanAnesthesi" name="org_unit_code" placeholder="" type="hidden" class="form-control block" value="<?= $visit['org_unit_code']; ?>" />
                                <input id="avtdoctor-laporanAnesthesi" name="doctor" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['doctor'] ?? $visit['fullname']; ?>" />
                                <input id="avtkal_id-laporanAnesthesi" name="kal_id" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['kal_id']; ?>" />
                                <input id="avttheid-laporanAnesthesi" name="theid" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['theid']; ?>" />
                                <input id="avtthename-laporanAnesthesi" name="thename" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['theid']; ?>" />
                                <input id="avttheaddress-laporanAnesthesi" name="theaddress" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['theid']; ?>" />
                                <input id="avtstatus_pasien_id-laporanAnesthesi" name="status_pasien_id" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['status_pasien_id']; ?>" />
                                <input id="avtisrj-laporanAnesthesi" name="isrj" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['isrj']; ?>" />
                                <input id="avtgender-laporanAnesthesi" name="gender" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['gender']; ?>" />
                                <input id="avtageyear-laporanAnesthesi" name="ageyear" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['ageyear']; ?>" />
                                <input id="avtagemonth-laporanAnesthesi" name="agemonth" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['agemonth']; ?>" />
                                <input id="avtageday-laporanAnesthesi" name="ageday" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['ageday']; ?>" />
                                <input id="avtbody_id-laporanAnesthesi" name="body_id_vt" placeholder="" type="hidden" class="form-control block" value="" />
                                <input id="avtmodified_by-laporanAnesthesi" name="modified_by" placeholder="" type="hidden" class="form-control block" value="<?= user()->username ?>" />
                                <input id="avttrans_id-laporanAnesthesi" name="trans_id" placeholder="" type="hidden" class="form-control block" value="<?= @$visit['trans_id']; ?>" />
                                <!--==new -->
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="row mt-4 mb-4" style="display: none">
                                                <label for="avtanamnase" class="col-xs-6 col-sm-6 col-md-3 col-form-label">(S)
                                                    Anamnesis</label>
                                                <div class="col-sm-10">
                                                    <textarea type="text" class="form-control" id="avtanamnase-laporanAnesthesi" name="anamnase" placeholder=""></textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <h3 id="">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class=" position-relative">
                                                                    <input type="text" name="weight" id="avtweight-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" name="height" id="avtheight-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avtheight-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                <label>Suhu(°C)</label>
                                                                <div class="position-relative">
                                                                    <input type="text" name="temperature" id="avttemperature-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avttemperature-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2 position-relative">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" name="nadi" id="avtnadi-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avtnadi-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group"><label>T.Darah(mmHg)</label>
                                                                <div class="col-sm-12 " style="display: flex;  align-items: center;">
                                                                    <div class="position-relative">
                                                                        <input type="text" name="tension_upper" id="avttension_upper-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                        <span class="h6" id="badge-avttension_upper-laporanAnesthesi"></span>
                                                                    </div>
                                                                    <h4 class="mx-2">/</h4>
                                                                    <div class="position-relative">
                                                                        <input type="text" name="tension_below" id="avttension_below-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                        <span class="h6" id="badge-avttension_below-laporanAnesthesi"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" name="saturasi" id="avtsaturasi-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avtsaturasi-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" name="nafas" id="avtnafas-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avtnafas-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" name="arm_diameter" id="avtarm_diameter-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avtarm_diameter-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" name="oxygen_usage" id="avtoxygen_usage-laporanAnesthesi" placeholder="" value="" class="form-control vitalsignclass-laporanAnesthesi">
                                                                    <span class="h6" id="badge-avtoxygen_usage-laporanAnesthesi"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--==new -->
                                                        <div class="col-xs-6 col-sm-6 col-md-3 mt-2">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select" name="vs_status_id" id="avtvs_status_id-laporanAnesthesi">
                                                        ...
                                                        <div class="col-sm-12 mt-2">
                                                            <div class="form-group">
                                                                <label>Pemeriksaan</label><textarea name="pemeriksaan" id="avtpemeriksaan-laporanAnesthesi" placeholder="" value="" class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- <div class="col-sm-12">
                                                        <div class="mb-4">
