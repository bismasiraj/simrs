                    ...
                    <div id="cpptDivForm" class="card border-1 rounded-4 p-4" style="display: none">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <button type="button" id="formaddacpptbtn" name="save" data-loading-text="Tambah" class="btn btn-info pull-right"><i class="fa fa-plus"></i> <span>Tambah</span></button>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="cpptTop">Top</label>
                                <div class="input-group">
                                    <select id="cpptTop" class="form-select">
                                        <option>10</option>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="mt-4 text-end">
                                        <div class="mb-0">
                                            <div>
                                                <button id="cpptSearchBtn" type="button" name="search" class="btn btn-primary waves-effect waves-light me-1"><i class="fa fa-search"></i> Cari</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content rounded-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="formaddacppt" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post">
                            ...
                            <input type="hidden" id="acpptpetugas_id" name="petugas_type">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="alo_anamnase" id="acpptalo_anamnase" placeholder="" value="" class="form-control" row="4"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="instruction" id="acpptinstruction" placeholder="" value="" class="form-control" row="4"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                ...
                <?php if (user()->checkPermission("cppt", "c")) {
                ?>
                    <button type="button" id="formaddacpptbtnid" name="save" data-loading-text="Tambah" class="btn btn-info pull-right formaddacpptbtn" style="display: none"><i class="fa fa-plus"></i> <span>Tambah</span></button>
                <?php
                } ?>
                <?php if (user()->checkPermission("cppt", "c") || user()->checkPermission("cppt", "u")) {
                ?>
