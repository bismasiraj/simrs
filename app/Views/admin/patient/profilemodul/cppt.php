                ...
                <div class="card">
                    <div class="card-body">
                        <form id="formaddacppt" accept-charset="utf-8" action="" enctype="multipart/form-data" method="post">
                            ...
                            <input type="hidden" id="acpptpetugas_type" name="petugas_type">
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapsePlanning" class="accordion-collapse collapse" aria-labelledby="headingPlanning" data-bs-parent="#accordionSOAP">
                                                                <div class="accordion-body text-muted">
                                                                    <div class="row">
                                                                        <div class="col-sm-12 mt-2">
                                                                            <div class="form-group"><label id="acpptinstruction_label">Catatan Planning</label><textarea name="instruction" id="acpptinstruction" placeholder="" value="" class="form-control" rows="4"></textarea></div>
                                                                        </div>
                                                                    </div>
                                                                    <script>
                                                                        // tinymce.init({
