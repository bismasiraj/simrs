                                    ...
                                    <div class="row row-eq">
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 col-xs-4">
                                                    <div class="form-group"><label for="no_skp">SEP RJ</label><input id="no_skp" name="no_skp" type="text" class="form-control" disabled /></div>
                                                </div>
                                                <div class="col-sm-2 col-xs-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-sm-4 col-xs-12">
                                                        <a data-toggle="modal" id="add" onclick="insertSep()" class="modalbtnpatient"><i class="fa fa-plus"></i> <span>Insert SEP</span></a>
                                                    </div>
                                                    <div class="col-sm-4 col-xs-12">
                                                        <a data-toggle="modal" id="add" onclick="editSep()" class="modalbtnpatient"><i class="fa fa-plus"></i> <span>Edit SEP</span></a>
                                                    </div>
                                                    <div class="col-sm-4 col-xs-12">
                                                        <a data-toggle="modal" id="add" onclick="deleteSep()" class="modalbtnpatient"><i class="fa fa-plus"></i> <span>Delete SEP</span></a>
                                                    </div>
                                                </div>
                                                <div class="">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-sm-4 col-xs-12">
                                                        <a data-toggle="modal" id="add" onclick="insertSKDP()" class="modalbtnpatient"><i class="fa fa-plus"></i> <span>SKDP</span></a>
                                                    </div>
                                                    <div class="col-sm-4 col-xs-12">
                                                        <a data-toggle="modal" id="add" onclick="insertSPRI()" class="modalbtnpatient"><i class="fa fa-plus"></i> <span>SPRI</span></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="dividerhr"></div>
