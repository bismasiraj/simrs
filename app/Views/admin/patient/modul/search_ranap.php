...
" id="rawat_inap">
    ...
    <div id="rawat_inap_show" style="display: none;">
            ...
            <div class="row mt-4 mb-4 gy-3">
                        ...
                        <?php else: ?>
                            ...
                            <?php foreach ($statusPasien as $item): ?>
                                <?php if (!empty($item['name_of_status_pasien'])): ?>
                                    <option value="<?= $item['status_pasien_id']; ?>"><?= $item['name_of_status_pasien']; ?>
                                    </option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        <?php endif; ?>
                ...
                <div class="col-lg-2 d-none">
                    ...
                    <div class="input-group" id="imulai">
                        <input name="mulai" type="text" class="form-control" placeholder="yyyy-mm-dd"
                            data-date-format="yyyy-mm-dd" data-provide="datepicker" data-date-autoclose="true"
                            data-date-container="#imulai" value="<?= date('Y-m-d'); ?>">
                ...
                <div class="col-lg-2 d-none">
                    ...
                    <div class="input-group" id="iakhir">
                        <input name="akhir" type="text" class="form-control" placeholder="yyyy-mm-dd"
                            data-date-format="yyyy-mm-dd" data-provide="datepicker" data-date-autoclose="true"
                            data-date-container="#iakhir" value="<?= date('Y-m-d'); ?>">
                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                    </div>
                </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <select name="keluar_id" id="icarakeluar" class="form-select">
                                <?php foreach ($caraKeluar as $val): ?>
                                    <option value="<?= $val['keluar_id']; ?>"><?= $val['cara_keluar']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-3">
