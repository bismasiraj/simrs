...
" id="rawat_inap">
    ...
    <form id="form2" action="" method="post">
        ...
        <div class="row mt-4 mb-4 gy-3">
            <div class="col-sm-6 col-lg-2">
                <label>Nama Pasien</label>
                <input type="text" name="nama" id="inama" class="form-control">
            </div>
            <div class="col-sm-6 col-lg-2">
                <label>No RM</label>
                <input type="text" name="norm" id="inorm" class="form-control">
            </div>
            <div class="col-sm-6 col-lg-2">
                <label>Bangsal <small class="text-danger">*</small></label>
                <select id="iklinik" class="form-select" name="klinik" onchange="showdate(this.value)">
                    <option value="%">Semua</option>
                    <?php
                    $cliniclist = [];
                    foreach ($clinic as $val) {
                        if ($val['stype_id'] == '3') {
                            $cliniclist[$val['name_of_clinic']] = $val['name_of_clinic'];
                        }
                    }
                    asort($cliniclist);
                    ...
                    if ($giTipe == '6') echo '<option value="P002">Kamar Operasi</option>';
                    ?>
                </select>
            ...
            <div class="col-sm-6 col-lg-2">
                ...
                <select id="dokter" class="form-select" name="dokter" onchange="showdate(this.value)">
                    ...
                    <?php else: ?>
                        <?php
                        if (!is_null(user()->employee_id) && isset($roles['11'])) {
                            echo '<option value="' . user()->employee_id . '">' . user()->getFullname() . '</option>';
                        } else {
                            $dokterlist = [];
                            ...
                            asort($dokterlist);
                            foreach ($dokterlist as $key => $value) {
                                echo "<option value=\"$key\">$value</option>";
                            }
                        }
                        ?>
            ...
            <div class="col-lg-2 d-none">
                ...
                <select name="statuspasien" id="istatuspasien" class="form-select">
                    <?php if ($giTipe == 7): ?>
                        <option value="18">BPJS Kesehatan</option>
                    <?php else: ?>
                        <option value="%">Semua</option>
                        <?php foreach ($statusPasien as $item): ?>
                            <?php if (!empty($item['name_of_status_pasien'])): ?>
                                <option value="<?= $item['status_pasien_id']; ?>"><?= $item['name_of_status_pasien']; ?></option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            ...
            <div class="col-lg-2 d-none">
                ...
                <input type="text" name="nokartu" id="inokartu" class="form-control">
            </div>

            <div class="col-lg-2 d-none">
                <label>Alamat</label>
                <input type="text" name="address" id="iaddress" class="form-control">
            </div>

            <div class="col-lg-2">
                <label>Tanggal Awal</label>
                <div class="input-group">
                    <input id="flatimulai" type="text" class="form-control dateflatpickr">
                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                    <input type="hidden" id="imulai" name="mulai">
                </div>
            </div>
            ...
            <div class="col-lg-2">
                ...
                <div class="input-group">
                    <input id="flatiakhir" type="text" class="form-control dateflatpickr">
                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                    <input type="hidden" id="iakhir" name="akhir">
                </div>
            </div>
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <select name="keluar_id" id="icarakeluar" class="form-select">
                            <option value="0">Masih Rawat Inap</option>
                            <option value="1">Dipulangkan</option>
                        </select>
                    </div>
                    <div class="col-3">
                        <button id="form2btn" type="submit" name="search" value="search_filter"
                            class="btn btn-primary checkbox-toggle btn-sm w-100">
                            <i class="fa fa-search"></i> Cari
                        </button>
                    </div>
                    <div class="col-3">
                        <button id="btnHandOver" type="button" name="search" value="search_filter"
                            class="btn btn-primary checkbox-toggle btn-sm w-100">
                            <i class="fas fa-hand-holding-heart"></i> HO
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="box-body">
        <div class="mt-4">
            <table id="tableSearchRanap" class="table table-bordered table-hover dt-responsive nowrap"
                data-export-title="<?php echo lang('Word.ipd_patient'); ?>" style="width:100%;text-align: center">
...
<div id="addRanapModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addRanapModal"
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table id="ketersediaanTT" class="table table-bordered table-striped table-centered table-hover"
                            data-export-title="<?= lang('Word.patient_list'); ?>">
                            <thead class="table-primary">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 row">
                            ...
                            <select class="form-select" id="ariclinic_id" name="clinic_id"
                                onchange="changeClinicInap(this.value)">
                                <?php foreach ($clinicInap as $key => $value) { ?>
                                    <option value="<?= $key; ?>"><?= $value; ?></option>
                                <?php } ?>
                            </select>
                            <div id="ariclinic_idalert" class="alert alert-danger mb-0" role="alert"
                                style="display: none;">
                        ...
                        <div class="mb-3 row">
                            ...
                            <select id="ariclass_room_id" class="form-select" name="class_room_id"
                                onchange="changeClassRoomTA(this.value)">
                            </select>
                            <div id="ariclass_room_idalert" class="alert alert-danger mb-0" role="alert"
                                style="display: none;">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div id="aribed_idalert" class="alert alert-danger mb-0" role="alert"
                                style="display: none;">
                        ...
                        <div class="mb-3 row">
                            ...
                            <input id="ariamount_paid" class="form-control" name="amount_paid" type="number"
                                step=".0,1">
                        ...
                        <div class="mb-3 row">
                            ...
                            <select class="form-select" id="ariclinic_type" name="clinic_type">
                                <?php foreach ($clinicType as $key => $value) { ?>
                                    <option value="<?= $clinicType[$key]['clinic_type']; ?>">
                                        <?= $clinicType[$key]['clinictype']; ?></option>
                                <?php } ?>
                            </select>
                            <div id="ariclinic_typealert" class="alert alert-danger mb-0" role="alert"
                                style="display: none;">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="input-group" id="arimulai" style="padding:0">
                                <input id="aritreat_date" name="treat_date" class="form-control" type="datetime-local"
                                    onchange="changeAriTreatDate()">
                                <!-- 
                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span> -->
                        ...
                        <div class="mb-3 row text-end">
                            <button id="saveAddAkomodasi" type="button" name="search" value="search_filter"
                                class="btn btn-primary btn-sm checkbox-toggle pull-right"
                                onclick="saveAddAkomodasi()">Simpan <i class=" fas fa-check-circle"></i></button>
                        </div>
                    </div>
                </div><!-- row -->
            </div>
                ...
                <div class="row">
                                ...
                                <div class="row ptt10" style="display:block">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12" style="text-align:center">
                                        ...
                                        <img class="rounded-circle avatar-lg"
                                            src="<?php echo base_url() . 'uploads/images/profile_male.png' ?>"
                    ...
                    <div class="col-md-9">
                        <form id="formAkomodasiView" action="" method="post" class="">
                            <table id="akomoDasiViewTable"
                                class="table table-bordered table-striped table-centered table-hover mb-4"
                                data-export-title="<?= lang('Word.patient_list'); ?>">
                                <thead class="table-primary">
                                    <tr style="text-align: center">
                                        <th>No</th>
                            ...
                            <div class="col-sm-12 col-xs-12 mb-4">
                                <div class="button-items">
                                    <div class="text-center">
                                        <button id="formAkomodasiViewBtn" type="submit"
                                            class="btn btn-primary waves-effect waves-light" style="display: none;"><i
                        ...
                        <div class="accordion" id="accordionRanap">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSepRanap">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseSepRanap" aria-expanded="true"
                                        aria-controls="collapseSepRanap">
                                        <b>Parameter SEP</b>
                                    </button>
                                </h2>
                                <div id="collapseSepRanap" class="accordion-collapse collapse"
                                    aria-labelledby="headingSepRanap" data-bs-parent="#accordionRanap" style="">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="asalrujukan">Asal Rujukan</label>
                                                    <div>
                                                        <select name='asalrujukan' id="taasalrujukan"
                                                            class="form-select select2 act" style="width:100%" disabled>
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="norujukan">No. Rujukan</label><input
                                                        id="tanorujukan" name="norujukan" type="text"
                                                        class="form-control" disabled /></div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="kdpoli">Poli Rujukan</label>
                                                    <div>
                                                        <select name='kdpoli' id="takdpoli"
                                                            class="form-select select2 act" style="width:100%" disabled>
                                                            <?php foreach ($inasisPoli as $key => $value) { ?>
                                                                <option value="<?= $inasisPoli[$key]['kdpoli']; ?>">
                                                                    <?= $inasisPoli[$key]['nmpoli']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group"><label for="tanggal_rujukan">Tgl
                                                        Rujukan</label><input type='date' name="tanggal_rujukan"
                                                        class="form-control" id='tatanggal_rujukan' /></div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="ppkrujukan">PPK Rujukan</label>
                                                    <div>
                                                        <select name='ppkrujukan' id="tappkrujukan"
                                                            class="form-control select2 act" style="width:100%"
                                                            disabled>
                                                            <?php foreach ($inasisFaskes as $key => $value) { ?>
                                                                <option value="<?= $inasisFaskes[$key]['kdprovider']; ?>">
                                                                    <?= $inasisFaskes[$key]['nmprovider']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="diag_awal">Diagnosis Rujukan</label>
                                                    <select class="form-select" name='diag_awal' id="tadiag_awal"
                                                        disabled>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-xs-12 mb-3">
                                                <div class="button-items">
                                                    <div class="d-grid">
                                                        <button id="getRujukanRanapBtn" type="button"
                                                            onclick="getRujukanRanap()"
                                                            class="btn btn-primary btn-lg waves-effect waves-light"><i
                                                                class="fa fa-plus"></i> <span>Get
                                                                Rujukan</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12 mb-3" style="display: none;">
                                                <div class="form-group"><label for="conclusion"></label><input
                                                        id="taconclusion" name="conclusion" type="text"
                                                        class="form-control" /></div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="diagnosa_id">Diagnosis
                                                        RS</label><input id="tadiagnosa_id" name="diagnosa_id"
                                                        type="text" class="form-control" disabled /></div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12 mb-3" style="display: none;">
                                                <div class="form-group"><label for="kdpoli_from"></label><input
                                                        id="takdpoli_from" name=" kdpoli_from" type="text"
                                                        class="form-control" /></div>
                                            </div>
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="tatujuankunj">Tujuan
                                                        Kunjungan</label>
                                                    <div>
                                                        <select name='tujuankunj' id="tatujuankunj"
                                                            class="form-select select2 act" style="width:100%">
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="takdpenunjang">Penunjang</label>
                                                    <div>
                                                        <select name='kdpenunjang' id="takdpenunjang"
                                                            class="form-select select2 act" style="width:100%">
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="taflagprocedure">Procedure</label>
                                                    <div>
                                                        <select name='flagprocedure' id="taflagprocedure"
                                                            class="form-select select2 act" style="width:100%">
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="taassesmentpelgroup">Assesment
                                                        Pelayanan</label>
                                                    <div>
                                                        <select name='assesmentpel' id="taassesmentpel"
                                                            class="form-select select2 act" style="width:100%">
                                                            <option value="1">Poli spesialis tidak tersedia pada hari
                                                                sebelumnya</option>
                                                            <option value="2">Jam poli telah berakhir pada hari
                                                                sebelumnya</option>
                                                            <option value="3">Dokter Spesialis yang dimaksud tidak
                                                                praktek pada hari sebelumnya</option>
                                            ...
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input id="taspecimenno" name="specimenno" type="text"
                                                        class="form-control" />
                                                    <span class="input-group-btn">
                                                        <button id="getSpriRanapBtn" class="form-control"
                                                            onclick="getSPRI()" type="button"><i
                                                                class="fa fa-search"></i></button>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12 mb-3">
                                                <div class="form-group"><label for="tano_skpinap">SEP RI</label><input
                                                        id="tano_skpinap" name="no_skpinap" type="text"
                                                        class="form-control" disabled /></div>
                                            </div>
                                            <div class="row mt-3 mb-3">
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="createSepInapBtn" type="button"
                                                                    onclick="insertSepInap()"
                                                                    class="btn btn-primary btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-plus"></i> <span>Insert
                                                                        SEP</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="editSepInapBtn" type="button"
                                                                    onclick="editSep()"
                                                                    class="btn btn-secondary btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-edit"></i> <span>Update
                                                                        SEP</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="deleteSepInapBtn" type="button"
                                                                    onclick="deleteSepInap()"
                                                                    class="btn btn-danger btn-lg waves-effect waves-light"><i
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                    aria-labelledby="flush-headingTwo" data-bs-parent="#accordionRanap">
                                    <div class="accordion-body text-muted">
                                        <div class="row">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="date" value=""
                                                        id="tglRencanaRujukanInap">
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    <label for="ppkRujukanInap">PPK Rujukan</label>
                                                    <select name='ppkRujukanInap' id="ppkRujukanInap"
                                                        class="form-select select2 act" style="width:100%">
                                                        <?php foreach ($inasisFaskes as $key => $value) { ?>
                                                            <option value="<?= $inasisFaskes[$key]['kdprovider']; ?>">
                                                                <?= $inasisFaskes[$key]['nmprovider']; ?></option>
                                            ...
                                            <div class="col-sm-3 col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    <input id="diagRujukanInap" name="diagRujukan" type="text"
                                                        class="form-control" />
                                                    <input id="nameDiagRujukanInap" name="nameDiagRujukan" type="hidden"
                                                        class="form-control" />
                                                    <span class="input-group-btn">
                                                        <button class="form-control" onclick="getDiagRujukan()"
                                            ...
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="poliRujukan" id="poliRujukanInap"
                                                        class="form-select ">
                                            ...
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="tipeRujukan" id="tipeRujukanInap"
                                                        class="form-select ">
                                            ...
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="form-group"><label for="noRujukan">Catatan</label>
                                                    <textarea id="catatanRujukanInap" name="catatanRujukan" type="text"
                                                        class="form-control">
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="form-group"><label for="noRujukan">No. Rujukan</label>
                                                    <input id="noRujukanInap" name="noRujukan" type="text"
                                            ...
                                            <div class="row mt-3 mb-3">
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="createSepInap" type="button"
                                                                    onclick="insertRujukanInap()"
                                                                    class="btn btn-primary btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-plus"></i> <span>Simpan
                                                                        Rujukan</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="deleteSepInap" type="button"
                                                                    onclick="deleteRujukanInap()"
                                                                    class="btn btn-danger btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-remove"></i> <span>Delete
                                                                        Rujukan</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSpriRanap">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseSpriRanap" aria-expanded="false"
                                        aria-controls="collapseSpriRanap">
                                        <b>Rencana SPRI</b>
                                    </button>
                                </h2>
                                <div id="collapseSpriRanap" class="accordion-collapse collapse"
                                    aria-labelledby="headingSpriRanap" data-bs-parent="#accordionRanap">
                                    <div class="accordion-body text-muted">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 col-xs-4 mb-3">
                                                <div class="form-group"><label for="tasprikddpjp">Dokter</label>
                                                    <div>
                                                        <select name="tasprikddpjp" id="tasprikddpjp"
                                            ...
                                            <div class="col-sm-2 col-xs-4 mb-3">
                                                <div class="form-group"><label for="tasprikdpoli">Poli Kontrol</label>
                                                    <div>
                                                        <select name="tasprikdpoli" id="tasprikdpoli"
                                                            class="form-select" style="width:100%">
                                                            <?php
                                                            $clinicList = array();
                                                            foreach ($clinic as $key => $value) {
                                            ...
                                            <div class="col-sm-2 mb-3">
                                                <div class="form-group"><label for="taspritglkontrol">Tgl Rencana
                                                        Kontrol</label>
                                                    <input type='date' name="taspritglkontrol" class="form-control"
                                                        id='taspritglkontrol' />
                                                </div>
                                            </div>
                                            <div class="col-sm-3 mb-3">
                                                <div class="form-group"><label for="tasprinosurat">No SPRI</label>
                                                    <input type='text' name="tasprinosurat" class="form-control"
                                                        id='tasprinosurat' />
                                                </div>
                                            </div>
                                            <div class="row mt-3 mb-3">
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="saveSpriRanapBtn" type="button"
                                                                    onclick="saveSpriRanap()"
                                                                    class="btn btn-primary btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-plus"></i>
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="checkSpriRanapBtn" type="button"
                                                                    onclick="checkSpriRanap()"
                                                                    class="btn btn-secondary btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-edit"></i> <span>Check
                                                                        SPRI</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="button-items">
                                                            <div class="d-grid">
                                                                <button id="deleteSpriRanapBtn" type="button"
                                                                    onclick="deleteSpriRanap()"
                                                                    class="btn btn-danger btn-lg waves-effect waves-light"><i
                                                                        class="fa fa-trash"></i> <span>Delete
                                                                        SPRI</span></button>
                                                            </div>
                ...
                <div id="handOverDocument" class="card border-1 rounded-4 m-4" style="display: none;">
                    <div class="card-body">
                            ...
                            <div class="box-body row mt-4 mb-4">
                                <div class="col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select id="handclinic_id" class="form-select" name="clinic_id"
                                            onchange="setClassRoom(this.value)" autocomplete="off">
                                            <?php $cliniclist = array();
                                            foreach ($clinic as $key => $value) {
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <select id="handclass_room_id" class="form-select" name="class_room_id"
                                                    autocomplete="off">
                                                    <option value="%">Semua</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="submit" name="search" value="search_filter"
                                                    class="btn btn-primary btn-sm checkbox-toggle pull-right w-100 h-100"><i
                        ...
                        <div class="row">
                            ...
                            <div id="btnTransferGRoup" class="col-md-2 button-container">
                                <div class="btn-group-vertical">
                                    <button class="btn btn-primary" onclick="transferToAfterHandoverAll()"> Pilih >>
                                    </button>
                            ...
                            <div id="groupAfterHandover" class="col-md-5">
                                <table id="tableAfterHandover"
                                    class="table table-bordered table-striped table-centered table-hover"
                                    data-export-title="<?= lang('Word.patient_list'); ?>">
                                    <thead class="table-primary">
                                        <tr style="text-align: center">
                                            <th class="justify-content-center align-items-center">
                                                <input id="afterHandoverCheckAll" class="form-check-input"
                                                    type="checkbox">
                                                <!-- <div class="form-check mb-3">
                                                    <label class="form-check-label" for="armGEN0009G0090501">Semua</label>
                                                </div> -->
                        ...
                        <div class="panel-footer text-end mb-4">
                            <button type="button" id="handSaveBtnId" name="save"
                                data-loading-text="<?php echo lang('processing') ?>"
                                class="btn btn-primary pull-right handSaveBtnId"><i class="fa fa-check-circle"></i>
                                <span>Simpan</span></button>
                            <button type="button" id="handEditBtnId" name="editrm" onclick=""
                                data-loading-text="<?php echo lang('processing') ?>"
                                class="btn btn-secondary pull-right handEditBtnId"><i class="fa fa-edit"></i>
                                <span>Edit</span></button>
                            <button type="button" id="handSignHandoverBtnId" name="signrm" onclick="signHandover()"
                                data-loading-text="<?php echo lang('processing') ?>"
                                class="btn btn-warning pull-right handSignBtnId"><i class="fa fa-signature"></i>
                                <span>Sign Handover</span></button>
                            <button type="button" id="handSignReceiveBtnId" name="signrm" onclick="signReceive()"
                                data-loading-text="<?php echo lang('processing') ?>"
                                class="btn btn-warning pull-right handSignBtnId" style="display: none;"><i
                                    class="fa fa-signature"></i> <span>Sign Receive</span></button>
                ...
                <div id="handOverList">
                    <div class="col-md-12">
                        <div class="box-tab-tools text-center m-4">
                            <a data-toggle="modal" onclick="setHandOver()" class="btn btn-primary btn-lg"
                                style="width: 300px"><i class=" fa fa-plus"></i> Tambah Dokumen</a>
                        </div>
                        <table id="tableHandover" class="table table-bordered table-striped table-centered table-hover"
                            data-export-title="<?= lang('Word.patient_list'); ?>">
                            <thead class="table-primary">
                                <tr style="text-align: center">
                                    <th>Tanggal</th>
...
<div id="historyCpptList" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="historyCpptList"
    aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-fullscreen-lg-down">
        <div class="modal-content rounded-4">
            ...
            <div class="modal-body">
                ...
                <div id="spectatorSessionRanap" class="box-tab-tools text-center mb-4"></div>
                <?php if (isset($roles['11'])) { ?>
                    <div class="d-flex mb-3">
                        <button type="button" class="btn btn-sm btn-primary ms-auto" data-bs-toggle="modal"
                            data-bs-target="#raberModal" id="btnRaberModal"><i class="fas fa-people-carry"></i> Rawat
                            Bersama</button>
                    </div>
                <?php } ?>
                <div id="loadingHistoryrajal"></div>
                <table id="historyCpptTable" class="table table-bordered table-striped table-centered table-hover"
                    data-export-title="<?= lang('Word.patient_list'); ?>">
                    <thead class="table-primary">
                        <tr>
                            <th class="text-center" style="width: auto;">Tanggal & Jam</th class="text-center">
                            <th class="text-center" style="width: auto;">Petugas</th class="text-center">
                            <th class="text-center" colspan="6" style="width: auto;">SOAP</th class="text-center">
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 75vh; overflow-y: auto;">
                <div id="inputRaberRanapForm" hidden>
                    <form action="" class="row" method="post" id="formRaberRanap">
                        ...
                        <input type="hidden" name="body_id" id="raber_body_id">
                        <div class="col-6" id="left_col-raber">
                            <div class="form-group mb-3">
                                <label for="select_doctor_to" class="form-label fw-bold mb-1">DPJP To</label>
                                <select id="select_doctor_to" class="form-select" name="employee_id_to"
                            ...
                            <div class="form-group mb-3">
                                <label for="select_department_ranap" class="form-label fw-bold mb-1">Department
                                    To</label>
                                <select id="select_department_ranap" class="form-select" name="specialist_type_id_to"
                                    autocomplete="off">
                            ...
                            <div class="form-group mb-3">
                                <label for="select_consul_type" class="form-label fw-bold mb-1">Consultation
                                    Type</label>
                                <select name="consul_type" id="select_consul_type" class="form-select">
                                    ...
                                    <option value="4">Konsulan Spesialis yang sama</option>
                                    <option value="5">Konsulan dokter Anestesi</option>
                                </select>
                            </div>
                            <div class="form-group mb-3">
                                <label for="consultation_date_raber" class="form-label fw-bold mb-1">Consultation
                                    Date</label>
                                <input type="date" name="document_date" id="consultation_date_raber"
                                    class="form-control bg-white dateflatpickr-ranap">
                            </div>
                            <div class="form-group mb-3">
                                <label for="consultation_desc_raber" class="form-label fw-bold mb-1">Consultation
                                    Desc</label>
                                <textarea name="description" id="consultation_desc_raber"
                                    class="form-control quill-editor-raber" rows="5"></textarea>
                            </div>
                            <button type="button" id="formsignarmraber" name="signrm" onclick="addSignUser()"
                        ...
                        <div class="col-6" id="right_col_raber">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="respon_date" id="response_date_raber"
                                    class="form-control bg-white dateflatpickr-ranap">
                            </div>
                            <div class="form-group mb-3">
                                <label for="response_desc_raber" class="form-label fw-bold mb-1">Response Desc</label>
                                <textarea name="description_to" id="response_desc_raber"
                                    class="form-control quill-editor-raber" rows="5"></textarea>
                            </div>
                            <button type="button" id="formsignarmraber2" name="signrm" onclick="addSignUser()"
                                data-loading-text="processing" class="btn btn-warning pull-right"><i
                                    class="fa fa-signature"></i> <span>Sign</span></button>
                        </div>
                    </form>
                ...
                <div class="box-tab-tools text-center mt-4 pb-3">
                    <a data-toggle="modal" id="show-slideRaberRanap1" class="btn btn-primary btn-lg"
                        style="width: 300px"><i class=" fa fa-plus"></i> Tambah
                        Rawat Bersama</a>
                    <a data-toggle="modal" id="show-slideRaberRanap" class="btn btn-primary btn-lg" style="width: 300px"
                        hidden><i class=" fa fa-plus"></i>
                        Sembunyikan Form</a>
                </div>
                <div class="table-responsive" id="tabels-history">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn-save-raber" hidden><i class="fas fa-save"></i>
                    Simpan</button>
                ...
                <form id="digitalSignForm" action="" method="post">
                    ...
                    <div id="signmedis">
                        ...
                        <div id="displaysignno_registration" class="form-group">
                            ...
                            <input id="signno_registration" type="text" class="form-control" name="no_registration"
                                placeholder="Nomor RM">
                        </div>
                        <div id="displaysigndatepasien" class="form-group">
                            <label for="signdatepasien">Tanggal Lahir (YYYYMMDD)</label>
                            <input id="signdatepasien" type="text" name="datebirth" class="form-control"
