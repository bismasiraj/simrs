...
<script>
    ...
    const addRowVitalSign = (data) => {
        ...
        data.map(item => {
            ...
            <tr>
                <td class="score_${item.body_id}" style="width: 10%; text-align: center; background:${getAdultScore("pernapasan", item?.nafas).colorPicker}">${getAdultScore("pernapasan", item?.nafas).score}</td>
