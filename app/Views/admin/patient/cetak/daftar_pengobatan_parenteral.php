    ...
    <div class="container-fluid mt-5">
        <form action="/admin/rekammedis/rmj2_4/ <?= base64_encode(json_encode($visit)); ?>" method="post"
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-5">
                    <h5>Waktu Pemberian Obat Parental</h5>
                    <ul>
                        <li><strong>1 X 1</strong> : 09.00 (Pagi)</li>
                        <li><strong>1 X 1</strong> : 21.00 (malam)</li>
                        <li><strong>2 X 1</strong> : 09.00, 21.00</li>
                        <li><strong>3 X 1</strong> : 05.00, 13.00, 21.00</li>
                        <li><strong>4 X 1</strong> : 05.00, 11.00, 17.00, 23.00</li>
