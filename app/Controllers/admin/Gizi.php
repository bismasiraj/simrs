...
class Gizi extends \App\Controllers\BaseController
{
    ...
    public function getGiziByID()
    {
        ...
        $query = $db->query("
        SELECT TOP(1) ASSESSMENT_NUTRITION.*, EXAMINATION_DETAIL.weight, EXAMINATION_DETAIL.height, EXAMINATION_INFO.ageyear,ASSESSMENT_NUTRITION_HABIT.DIETARY_HABIT  FROM ASSESSMENT_NUTRITION
        LEFT JOIN EXAMINATION_DETAIL ON ASSESSMENT_NUTRITION.VISIT_ID = EXAMINATION_DETAIL.VISIT_ID
        LEFT JOIN EXAMINATION_INFO ON EXAMINATION_DETAIL.DOCUMENT_ID = EXAMINATION_INFO.PASIEN_DIAGNOSA_ID
