...
use App\Models\AssInvasifModel;
use CodeIgniter\Controller;

class Assinvasif extends \App\Controllers\BaseController
{
    protected $model;
    ...
    public function getData()
    {
        ...
        $data = $this->lowerKey(
            $db->query("SELECT * from assessment_invasif_tools where visit_id = ?",[$formData['visit_id']])->getResultArray()
        );
