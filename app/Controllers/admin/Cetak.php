   ...
   WHERE ( T.NO_REGISTRATION = '$nomor' ) AND
    ...
    public function cetakVitalSign($visit, $vactination_id = null)
    {
        ...
        if ($this->request->is('get')) {
            ...
            //     ex.*, 
            //     c.name_of_clinic, 
            //     isnull(ea.fullname, u.username) as fullname, gcs.GCS_DESC
            // from examination_detail ex 
            // inner join users u on u.username = ex.MODIFIED_BY
            // left outer join employee_all ea on u.employee_id = ea.employee_id 
            // left outer join clinic c on ex.clinic_id = c.clinic_id 
