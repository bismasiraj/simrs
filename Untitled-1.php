                            ...
                            <div class="tab-pane active" id="activity">
                                <div class="box-tab-header">
                                    ...
                                    <div class="box-tab-tools">
                                        <?php if ($this->rbac->hasPrivilege('recheckup', 'can_add')) {
                                            if ($is_discharge) { ?>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <div class="bill_item_footer text-muted"><label><?php if ($charges_value["note"] != '') {
                                                                                                                echo $this->lang->line('charge_note') . ': ';
                                                                                                            } ?></label> <?php echo $charges_value["note"]; ?></div>
                                                        </td>
                                        ...
                                        <table class="printablea4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2" class="text-right ipdbilltable">
                                                    <input type="text" placeholder="Total" value="0" name="apply_charge" id="editapply_charge" style="width: 30%; float: right" class="form-control total" readonly />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right ipdbilltable">
                                                    ...
                                                    <input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="charge_tax" id="editcharge_tax" class="form-control charge_tax" readonly style="width: 70%; float: right;font-size: 12px;" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" class="text-right ipdbilltable">
                                                    <input type="text" placeholder="Net Amount" value="0" name="amount" id="editfinal_amount" style="width: 30%; float: right" class="form-control net_amount" readonly />
                                                </td>
                                            </tr>
                                        </table>
    ...
    function editRecord(visitid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                //s$("#edit_organisation").val(data.organisation);
